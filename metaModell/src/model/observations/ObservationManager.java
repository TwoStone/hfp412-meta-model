...
public class ObservationManager extends PersistentObject implements PersistentObservationManager{
    ...
    public PersistentMObservation createObservation(final String name, final PersistentMObservationType theType, final PersistentMObject theObsObject, final PersistentMEnumValue enumValue) 
				throws model.ConsistencyException, PersistenceException{

		if (!theType.getEnumType().equals(enumValue.getTheType()))
			throw new model.ConsistencyException(ExceptionConstants.CE_ENUM_TYPE_NOT_VALID);
    ...
    public void deleteObservation(final PersistentMObservation observation) 
		...
		if (observation.fetchDependentItems().getLength() == 0) {
			...
			throw new model.ConsistencyException(ExceptionConstants.CE_OBSERVATION_DELETE);
		}
