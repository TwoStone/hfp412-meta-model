...
public class NotComputableException extends model.UserException{
    ...
    public NotComputableException(String message) throws persistence.PersistenceException {
        super(message);        
    }
    ...
    public void accept(UserExceptionVisitor visitor) throws PersistenceException {
        visitor.handleNotComputableException(this);
    }
    public <R> R accept(UserExceptionReturnVisitor<R>  visitor) throws PersistenceException {
         return visitor.handleNotComputableException(this);
    }
