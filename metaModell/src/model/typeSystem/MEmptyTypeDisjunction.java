...
public class MEmptyTypeDisjunction extends model.typeSystem.MDisjunctiveNormalForm implements PersistentMEmptyTypeDisjunction {
	...
	@Override
	public <E extends UserException> void accept(final MDisjunctiveNormalFormExceptionVisitor<E> visitor) throws PersistenceException, E {
		visitor.handleMEmptyTypeDisjunction(this);
	}

	@Override
	public <R, E extends UserException> R accept(final MDisjunctiveNormalFormReturnExceptionVisitor<R, E> visitor) throws PersistenceException, E {
		return visitor.handleMEmptyTypeDisjunction(this);
	}
	...
	@Override
	public <E extends UserException> void accept(final MAbstractTypeDisjunctionExceptionVisitor<E> visitor) throws PersistenceException, E {
		visitor.handleMEmptyTypeDisjunction(this);
	}

	@Override
	public <R, E extends UserException> R accept(final MAbstractTypeDisjunctionReturnExceptionVisitor<R, E> visitor) throws PersistenceException, E {
		return visitor.handleMEmptyTypeDisjunction(this);
	}
	...
	public void initialize(final Anything This, final java.util.Hashtable<String, Object> final$$Fields) throws PersistenceException {
		...
		if (this.equals(This)) {
			final PersistentCONCMModelItem myCONCMModelItem = model.CONCMModelItem.createCONCMModelItem(this.isDelayed$Persistence(),
					(PersistentMEmptyTypeDisjunction) This);
	...
	@Override
	public PersistentMDisjunctiveNormalForm transientMultiply(final PersistentMDisjunctiveNormalForm other) throws PersistenceException {
		return getThis();
	}
	...
	public void delete() throws model.ConsistencyException, PersistenceException {
		throw new ConsistencyException(ExceptionConstants.CE_DELETE_NOTHING);
	}
