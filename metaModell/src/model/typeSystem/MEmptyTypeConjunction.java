...
public class MEmptyTypeConjunction extends model.typeSystem.MAtomicTypeConjunction implements PersistentMEmptyTypeConjunction {
	...
	@Override
	public <E extends UserException> void accept(final MAtomicTypeConjunctionExceptionVisitor<E> visitor) throws PersistenceException, E {
		visitor.handleMEmptyTypeConjunction(this);
	}

	@Override
	public <R, E extends UserException> R accept(final MAtomicTypeConjunctionReturnExceptionVisitor<R, E> visitor) throws PersistenceException, E {
		return visitor.handleMEmptyTypeConjunction(this);
	}
	...
	@Override
	public <E extends UserException> void accept(final MAbstractTypeConjunctionExceptionVisitor<E> visitor) throws PersistenceException, E {
		visitor.handleMEmptyTypeConjunction(this);
	}

	@Override
	public <R, E extends UserException> R accept(final MAbstractTypeConjunctionReturnExceptionVisitor<R, E> visitor) throws PersistenceException, E {
		return visitor.handleMEmptyTypeConjunction(this);
	}
	...
	@Override
	public <E extends UserException> void accept(final MComplexTypeExceptionVisitor<E> visitor) throws PersistenceException, E {
		visitor.handleMEmptyTypeConjunction(this);
	}

	@Override
	public <R, E extends UserException> R accept(final MComplexTypeReturnExceptionVisitor<R, E> visitor) throws PersistenceException, E {
		return visitor.handleMEmptyTypeConjunction(this);
	}
	...
	public void initialize(final Anything This, final java.util.Hashtable<String, Object> final$$Fields) throws PersistenceException {
		...
		if (this.equals(This)) {
			final PersistentCONCMModelItem myCONCMModelItem = model.CONCMModelItem.createCONCMModelItem(this.isDelayed$Persistence(),
					(PersistentMEmptyTypeConjunction) This);
	...
	public void delete() throws model.ConsistencyException, PersistenceException {
		throw new ConsistencyException(ExceptionConstants.CE_DELETE_ANYTHING);
	}
	...
	@Override
	public PersistentMAtomicTypeConjunction transientMultiply(final PersistentMAtomicTypeConjunction other) throws PersistenceException {
		return other;
	}
