...
public class AddToHierarchyCommandProxi extends PersistentProxi implements PersistentAddToHierarchyCommand{
    
    public AddToHierarchyCommandProxi(long objectId) {
        super(objectId);
    }
    public AddToHierarchyCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
