...
public class MAHierarchyProxi extends PersistentProxi implements PersistentMAHierarchy{
    
    public MAHierarchyProxi(long objectId) {
        super(objectId);
    }
    public MAHierarchyProxi(PersistentInCacheProxi object) {
        super(object);
    }
