...
public class CreateSubTypeCommandICProxi extends PersistentInCacheProxi implements PersistentCreateSubTypeCommand{
    
    public CreateSubTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateSubTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
