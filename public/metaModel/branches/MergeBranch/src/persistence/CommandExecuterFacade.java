...
public class CommandExecuterFacade{
    ...
    public CommandExecuterProxi newCommandExecuter(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CommandExecuterProxi)PersistentProxi.createProxi(createMinusStorePlus, -119);
        ...
        return (CommandExecuterProxi)PersistentProxi.createProxi(id, -119);
    }
