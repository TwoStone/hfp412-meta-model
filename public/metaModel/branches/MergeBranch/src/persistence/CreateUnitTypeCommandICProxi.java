...
public class CreateUnitTypeCommandICProxi extends PersistentInCacheProxi implements PersistentCreateUnitTypeCommand{
    
    public CreateUnitTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateUnitTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
