...
public class MAHierarchy extends ViewObject implements MAHierarchyView{
    
    protected String name;
    protected java.util.Vector<MAssociationView> associations;
    
    public MAHierarchy(String name,java.util.Vector<MAssociationView> associations,long id, long classId) {
