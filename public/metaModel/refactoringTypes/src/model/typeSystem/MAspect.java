...
public class MAspect extends PersistentObject implements PersistentMAspect {
	...
	public static PersistentMAspect createMAspect(String name, boolean delayed$Persistence, PersistentMAspect This)
	...
	public java.util.Hashtable<String, Object> toHashtable(java.util.Hashtable<String, Object> allResults, int depth,
		...
		if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth) {
			...
			result.put(
					"types",
					this.getTypes(tdObserver).getVector(allResults, (depth > 1 ? depth : depth + 1), essentialLevel,
	...
	public MAspect provideCopy() throws PersistenceException {
		MAspect result = this;
		result = new MAspect(this.name, this.This, this.getId());
	...
	public MAtomicTypeSearchList getTypes() throws PersistenceException {
		...
		if (result == null)
			result = ConnectionHandler.getTheConnectionHandler().theMAtomicTypeFacade.inverseGetAspect(this.getId(),
					this.getClassId());
		return result;
	}
