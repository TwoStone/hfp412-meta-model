...
public class MeasurementTest extends TestingBase {
	...
	public void onMeasurement_test02() throws PersistenceException, CycleException, ConsistencyException {
		...
		final PersistentMMeasurementType msmntType1 = MMeasurementType.createMMeasurementType(type, unitType1, "jau");
		final PersistentMMeasurementType msmntType2 = MMeasurementType.createMMeasurementType(type, unitType1, "jau");
		final PersistentMeasurement msmnt1 = Measurement.createMeasurement(obj2, msmntType1, quantity1);
		...
		fail("Entries eines Accounts müssen schon vom selben MeasurementTyp sein!");
	}

	@Test(expected = PersistenceException.class)
	public void onMeasurement_test03() throws PersistenceException, CycleException, ConsistencyException {
		...
		fail("MeasurementTypes der Entries eines Accounts müssen vom selben UnitType sein!");
	}
