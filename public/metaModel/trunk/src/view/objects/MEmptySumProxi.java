...
public class MEmptySumProxi extends MSumTypeProxi implements MEmptySumView{
    
    public MEmptySumProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    @SuppressWarnings("unchecked")
    public MEmptySumView getRemoteObject(java.util.Hashtable<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        MEmptySumView result$$ = new MEmptySum(containedTypes,(String)TypeLinkOperator, this.getId(), this.getClassId());
