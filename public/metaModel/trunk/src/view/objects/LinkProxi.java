...
public class LinkProxi extends MessageOrLinkProxi implements LinkView{
    
    public LinkProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public LinkView getRemoteObject(java.util.Hashtable<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
    ...
    public ViewObjectInTree getChild(int originalIndex) throws ModelException {
        ...
        if(index == 0 && this.getType() != null) return new TypeLinkWrapper(this, originalIndex, (ViewRoot)this.getType());
