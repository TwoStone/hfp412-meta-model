...
public abstract class MAbstractSumType extends view.objects.MComplexType implements MAbstractSumTypeView{
    
    
    public MAbstractSumType(java.util.Vector<MTypeView> containedTypes,long id, long classId) {
