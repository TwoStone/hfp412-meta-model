...
public class MEmptySum extends view.objects.MSumType implements MEmptySumView{
    
    
    public MEmptySum(java.util.Vector<MType> containedTypes,String TypeLinkOperator,long id, long classId) {
