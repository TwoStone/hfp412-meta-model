...
public class CompUnit extends view.objects.AbsUnit implements CompUnitView{
    ...
    public CompUnit(AbsUnitTypeView type,String name,java.util.Vector<ReferenceView> refs,MBooleanView isFinal,long id, long classId) {
    ...
    public void resolveProxies(java.util.Hashtable<String, Object> resultTable) throws ModelException {
        ...
        MBooleanView isFinal = this.getIsFinal();
        if (isFinal != null) {
