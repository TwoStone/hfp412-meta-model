...
public class MAbstractProductTypeProxi extends MComplexTypeProxi implements MAbstractProductTypeView{
    ...
    public MAbstractProductTypeView getRemoteObject(java.util.Hashtable<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        MAbstractProductTypeView result$$ = new MAbstractProductType(containedTypes, this.getId(), this.getClassId());
