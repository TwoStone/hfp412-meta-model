...
public class ServerClientView extends JPanel implements ExceptionAndEventHandler {
		...
		if (selected != null) {
			if (selected instanceof MEnumView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						if (javax.swing.JOptionPane.showConfirmDialog(getNavigationPanel(), "Enum l�schen"
								+ Wizard.ConfirmQuestionMark, "Best�tigen", javax.swing.JOptionPane.OK_CANCEL_OPTION,
			...
			if (selected instanceof MEnumValueView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						if (javax.swing.JOptionPane.showConfirmDialog(getNavigationPanel(), "Enum Wert l�schen"
								+ Wizard.ConfirmQuestionMark, "Best�tigen", javax.swing.JOptionPane.OK_CANCEL_OPTION,
								javax.swing.JOptionPane.QUESTION_MESSAGE, null) == javax.swing.JOptionPane.YES_OPTION) {
							try {
			...
			if (selected instanceof MObservationTypeView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						if (javax.swing.JOptionPane.showConfirmDialog(getNavigationPanel(), "Observation Type l�schen"
								+ Wizard.ConfirmQuestionMark, "Best�tigen", javax.swing.JOptionPane.OK_CANCEL_OPTION,
								javax.swing.JOptionPane.QUESTION_MESSAGE, null) == javax.swing.JOptionPane.YES_OPTION) {
							try {
			...
			if (selected instanceof UnitTypeView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						final ServerCreateUnitUnitTypeStringMssgWizard wizard = new ServerCreateUnitUnitTypeStringMssgWizard(
								"Create unit");
			...
			if (selected instanceof AbsQuantityView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						final ServerAddAbsQuantityAbsQuantityMssgWizard wizard = new ServerAddAbsQuantityAbsQuantityMssgWizard(
								"add");
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						final ServerDivAbsQuantityAbsQuantityMssgWizard wizard = new ServerDivAbsQuantityAbsQuantityMssgWizard(
								"div");
						wizard.setFirstArgument((AbsQuantityView) selected);
						wizard.pack();
						wizard.setPreferredSize(new java.awt.Dimension(getNavigationPanel().getWidth(), wizard
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						final ServerMulAbsQuantityAbsQuantityMssgWizard wizard = new ServerMulAbsQuantityAbsQuantityMssgWizard(
								"mul");
						wizard.setFirstArgument((AbsQuantityView) selected);
						wizard.pack();
						wizard.setPreferredSize(new java.awt.Dimension(getNavigationPanel().getWidth(), wizard
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						final ServerSubAbsQuantityAbsQuantityMssgWizard wizard = new ServerSubAbsQuantityAbsQuantityMssgWizard(
								"sub");
						wizard.setFirstArgument((AbsQuantityView) selected);
						wizard.pack();
						wizard.setPreferredSize(new java.awt.Dimension(getNavigationPanel().getWidth(), wizard
			...
			if (selected instanceof MObjectView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						final ServerAssignNameMObjectNameStringMssgWizard wizard = new ServerAssignNameMObjectNameStringMssgWizard(
								"Benennen");
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						final ServerAddTypeMObjectMAtomicTypeMssgWizard wizard = new ServerAddTypeMObjectMAtomicTypeMssgWizard(
								"Typen hinzuf?gen");
						wizard.setFirstArgument((MObjectView) selected);
						wizard.pack();
						wizard.setPreferredSize(new java.awt.Dimension(getNavigationPanel().getWidth(), wizard
			...
			if (selected instanceof MObservationView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						if (javax.swing.JOptionPane.showConfirmDialog(getNavigationPanel(), "Observation l�schen"
								+ Wizard.ConfirmQuestionMark, "Best�tigen", javax.swing.JOptionPane.OK_CANCEL_OPTION,
								javax.swing.JOptionPane.QUESTION_MESSAGE, null) == javax.swing.JOptionPane.YES_OPTION) {
							try {
			...
			if (selected instanceof HierarchyView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						if (javax.swing.JOptionPane.showConfirmDialog(getNavigationPanel(), "removeHierarchy"
								+ Wizard.ConfirmQuestionMark, "Best�tigen", javax.swing.JOptionPane.OK_CANCEL_OPTION,
								javax.swing.JOptionPane.QUESTION_MESSAGE, null) == javax.swing.JOptionPane.YES_OPTION) {
							try {
			...
			if (selected instanceof QuantityView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						final ServerConvertQuantityAbsUnitMssgWizard wizard = new ServerConvertQuantityAbsUnitMssgWizard(
								"convert");
			...
			if (selected instanceof UnitTypeManagerView) {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						if (javax.swing.JOptionPane.showConfirmDialog(getNavigationPanel(), "fetchScalarType"
								+ Wizard.ConfirmQuestionMark, "Best�tigen", javax.swing.JOptionPane.OK_CANCEL_OPTION,
								javax.swing.JOptionPane.QUESTION_MESSAGE, null) == javax.swing.JOptionPane.YES_OPTION) {
							try {
				...
				item.addActionListener(new java.awt.event.ActionListener() {
					@Override
					public void actionPerformed(final java.awt.event.ActionEvent e) {
						if (javax.swing.JOptionPane.showConfirmDialog(getNavigationPanel(), "fetchScalar"
								+ Wizard.ConfirmQuestionMark, "Best�tigen", javax.swing.JOptionPane.OK_CANCEL_OPTION,
								javax.swing.JOptionPane.QUESTION_MESSAGE, null) == javax.swing.JOptionPane.YES_OPTION) {
							try {
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("referenceUnit", "view.UnitView", new ListRoot(getConnection()
								.referenceUnit_Path_In_AddReference()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerAddAbsQuantityAbsQuantityMssgWizard extends Wizard {
		...
		protected void perform() {
			try {
				getConnection().add(firstArgument,
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("scheme", "view.NameSchemeView", new ListRoot(getConnection()
								.scheme_Path_In_AssignNameScheme()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
		...
		protected void addParameters() {
			getParametersPanel().add(new ObjectSelectionPanel("scheme", "view.NameView", null, this) {
				...
				protected ViewRoot getBrowserRoot() {
					{
						try {
							return new ListRoot(getConnection().scheme_Path_In_AssignName(
									(MObjectView) this.navigationRoot));
						} catch (final ModelException me) {
	...
	class ServerChangeAbstractMAtomicTypeMBooleanSUBTYPENameMssgWizard extends Wizard {
		...
		protected void perform() {
			try {
				getConnection().changeAbstract(firstArgument,
						((StringSelectionPanel) getParametersPanel().getComponent(0)).getResult());
				getConnection().setEagerRefresh();
				setVisible(false);
				dispose();
		...
		protected void addParameters() {
			getParametersPanel().add(
					new RegExprSelectionPanel("newAbstractType", this,
	...
	class ServerCreateAccountTypeAccountTypeManagerStringMTypeUnitTypeMssgWizard extends Wizard {
		...
		protected void addParameters() {
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("type", "view.MTypeView", new ListRoot(getConnection()
								.type_Path_In_CreateAccountType()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("unitType", "view.UnitTypeView", new ListRoot(getConnection()
								.unitType_Path_In_CreateAccountType()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("type", "view.MAccountTypeView", new ListRoot(getConnection()
								.type_Path_In_CreateAccount()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("target", "view.MTypeView", new ListRoot(getConnection()
								.target_Path_In_CreateConstant()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("object", "view.MObjectView", new ListRoot(getConnection()
								.object_Path_In_CreateEntry()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("measurementType", "view.MMeasurementTypeView", new ListRoot(
								getConnection().measurementType_Path_In_CreateEntry()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("quantity", "view.QuantityView", new ListRoot(getConnection()
								.quantity_Path_In_CreateEntry()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerCreateEnumValueMEnumStringMssgWizard extends Wizard {
		...
		protected void perform() {
			try {
				getConnection().createEnumValue(firstArgument,
						((StringSelectionPanel) getParametersPanel().getComponent(0)).getResult());
				getConnection().setEagerRefresh();
				setVisible(false);
				dispose();
	...
	class ServerCreateLinkLinkManagerAssociationMObjectMObjectMssgWizard extends Wizard {
		...
		protected void addParameters() {
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("type", "view.AssociationView", new ListRoot(getConnection()
								.type_Path_In_CreateLink()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("source", "view.MObjectView", new ListRoot(getConnection()
								.source_Path_In_CreateLink()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("target", "view.MObjectView", new ListRoot(getConnection()
								.target_Path_In_CreateLink()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectCollectionSelectionPanel("otherTypes", "view.MAtomicTypeView", new ListRoot(
								getConnection().otherTypes_Path_In_CreateMObject()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerCreateMeasurementTypeMeasurementTypeManagerStringMTypeUnitTypeMssgWizard extends Wizard {
		...
		protected ServerCreateMeasurementTypeMeasurementTypeManagerStringMTypeUnitTypeMssgWizard(
				final String operationName) {
			super();
			getOkButton().setText(operationName);
		}
		...
		protected void addParameters() {
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("type", "view.MTypeView", new ListRoot(getConnection()
								.type_Path_In_CreateMeasurementType()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerCreateNameSchemeNameSchemeManagerStringStringMBooleanSUBTYPENameMssgWizard extends Wizard {
		...
		protected ServerCreateNameSchemeNameSchemeManagerStringStringMBooleanSUBTYPENameMssgWizard(
				final String operationName) {
			super();
			getOkButton().setText(operationName);
		}
	...
	class ServerCreateObsTypeStringMEnumMTypeMssgWizard extends Wizard {
		...
		protected void addParameters() {
			getParametersPanel().add(new StringSelectionPanel("name", this));
			getParametersPanel().add(
					new ObjectSelectionPanel("enumType", "view.MEnumView", (ViewRoot) getConnection().getServerView(),
							this));
			getParametersPanel().add(
					new ObjectSelectionPanel("theType", "view.MTypeView", (ViewRoot) getConnection().getServerView(),
							this));
		}
	...
	class ServerCreateObservationMObservationTypeStringMObjectMEnumValueMssgWizard extends Wizard {
		...
		protected void perform() {
			try {
				getConnection().createObservation(firstArgument,
						((StringSelectionPanel) getParametersPanel().getComponent(0)).getResult(),
						(MObjectView) ((ObjectSelectionPanel) getParametersPanel().getComponent(1)).getResult(),
		...
		protected void addParameters() {
			getParametersPanel().add(new StringSelectionPanel("name", this));
			getParametersPanel().add(
					new ObjectSelectionPanel("theObsObject", "view.MObjectView", (ViewRoot) getConnection()
							.getServerView(), this));
			getParametersPanel().add(
					new ObjectSelectionPanel("enumValue", "view.MEnumValueView", (ViewRoot) getConnection()
							.getServerView(), this));
		}
	...
	class ServerCreateOperationMTypeMTypeStringFormalParameterLSTMssgWizard extends Wizard {
		...
		protected void addParameters() {
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("target", "view.MTypeView", new ListRoot(getConnection()
								.target_Path_In_CreateOperation()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectCollectionSelectionPanel("fp", "view.FormalParameterView", new ListRoot(
								getConnection().fp_Path_In_CreateOperation()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerCreateOperationOperationManagerMTypeMTypeStringFormalParameterLSTMssgWizard extends Wizard {
		...
		protected ServerCreateOperationOperationManagerMTypeMTypeStringFormalParameterLSTMssgWizard(
				final String operationName) {
			super();
			getOkButton().setText(operationName);
		}
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("source", "view.MTypeView", new ListRoot(getConnection()
								.source_Path_In_CreateOperation()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerCreateStaticOpOperationManagerStringMTypeFormalParameterLSTMssgWizard extends Wizard {
		...
		protected void addParameters() {
			...
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("target", "view.MTypeView", new ListRoot(getConnection()
								.target_Path_In_CreateStaticOp()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
			...
			try {
				getParametersPanel().add(
						new ObjectCollectionSelectionPanel("fp", "view.FormalParameterView", new ListRoot(
								getConnection().fp_Path_In_CreateStaticOp()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerCreateVoidOperationMTypeStringFormalParameterLSTMssgWizard extends Wizard {
		...
		protected void addParameters() {
			...
			try {
				getParametersPanel().add(
						new ObjectCollectionSelectionPanel("fp", "view.FormalParameterView", new ListRoot(
								getConnection().fp_Path_In_CreateVoidOperation()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerCreateVoidOperationOperationManagerMTypeStringFormalParameterLSTMssgWizard extends Wizard {
		...
		protected ServerCreateVoidOperationOperationManagerMTypeStringFormalParameterLSTMssgWizard(
				final String operationName) {
			super();
			getOkButton().setText(operationName);
		}
		...
		protected void addParameters() {
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("source", "view.MTypeView", new ListRoot(getConnection()
								.source_Path_In_CreateVoidOperation()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerDivAbsQuantityAbsQuantityMssgWizard extends Wizard {
		...
		protected void perform() {
			try {
				getConnection().div(firstArgument,
						(AbsQuantityView) ((ObjectSelectionPanel) getParametersPanel().getComponent(0)).getResult());
				getConnection().setEagerRefresh();
				setVisible(false);
				dispose();
	...
	class ServerMulAbsQuantityAbsQuantityMssgWizard extends Wizard {
		...
		protected void perform() {
			try {
				getConnection().mul(firstArgument,
						(AbsQuantityView) ((ObjectSelectionPanel) getParametersPanel().getComponent(0)).getResult());
				getConnection().setEagerRefresh();
				setVisible(false);
				dispose();
		...
		protected void addParameters() {
			getParametersPanel().add(new ObjectSelectionPanel("oldType", "view.MAtomicTypeView", null, this) {
				...
				protected ViewRoot getBrowserRoot() {
					{
						try {
							return new ListRoot(getConnection().oldType_Path_In_RemoveType(
									(MObjectView) this.navigationRoot));
						} catch (final ModelException me) {
							return this.navigationRoot;
						} catch (final UserException ue) {
	...
	class ServerReplaceTypeMObjectMAtomicTypeMAtomicTypeMssgWizard extends Wizard {
		...
		protected void addParameters() {
			getParametersPanel().add(new ObjectSelectionPanel("oldType", "view.MAtomicTypeView", null, this) {
				...
				protected ViewRoot getBrowserRoot() {
					{
						try {
							return new ListRoot(getConnection().oldType_Path_In_ReplaceType(
									(MObjectView) this.navigationRoot));
						} catch (final ModelException me) {
							return this.navigationRoot;
						} catch (final UserException ue) {
			...
			getParametersPanel().add(new ObjectSelectionPanel("newType", "view.MAtomicTypeView", null, this) {
				...
				protected ViewRoot getBrowserRoot() {
					{
						try {
							return new ListRoot(getConnection().newType_Path_In_ReplaceType(
									(MAtomicTypeView) this.navigationRoot));
						} catch (final ModelException me) {
							return this.navigationRoot;
						} catch (final UserException ue) {
							return this.navigationRoot;
		...
		protected void handleDependencies(final int i) {
			...
			if (i == 1) {
				final ViewRoot dependent = (ViewRoot) ((ObjectSelectionPanel) getParametersPanel().getComponent(0))
						.getResult();
	...
	class ServerSetDefaultUnitUnitTypeUnitMssgWizard extends Wizard {
		...
		protected void addParameters() {
			try {
				getParametersPanel().add(
						new ObjectSelectionPanel("defaultUnit", "view.UnitView", new ListRoot(getConnection()
								.defaultUnit_Path_In_SetDefaultUnit()), this));
			} catch (final ModelException me) {
				;
				handleException(me);
				setVisible(false);
	...
	class ServerSubAbsQuantityAbsQuantityMssgWizard extends Wizard {
		...
		protected void perform() {
			try {
				getConnection().sub(firstArgument,
						(AbsQuantityView) ((ObjectSelectionPanel) getParametersPanel().getComponent(0)).getResult());
				getConnection().setEagerRefresh();
				setVisible(false);
				dispose();
