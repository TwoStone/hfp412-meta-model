	...
	private java.util.Vector<javax.swing.JButton> getToolButtonsForStaticOperations() {
		...
		currentButton.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent e) {
				ServerCreateTypeConjunctionMTypeLSTMssgWizard wizard = new ServerCreateTypeConjunctionMTypeLSTMssgWizard(
		...
		currentButton.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent e) {
				ServerCreateTypeDisjunctionMTypeLSTMssgWizard wizard = new ServerCreateTypeDisjunctionMTypeLSTMssgWizard(
