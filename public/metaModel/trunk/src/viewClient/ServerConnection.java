...
public class ServerConnection extends ConnectionMaster {
	...
	public synchronized void convertToDefault(final QuantityView quantity) throws ModelException {
		try {
			final Vector<Object> parameters = new Vector<Object>();
			parameters.add(((view.objects.ViewProxi) quantity).createProxiInformation());
			final Hashtable<?, ?> success = this.execute(this.connectionName, "convertToDefault", parameters);
			if (!((Boolean) success.get(common.RPCConstantsAndServices.OKOrNotOKResultFieldName)).booleanValue()) {
				if (((Integer) success.get(common.RPCConstantsAndServices.ErrorNumberFieldName)).intValue() == 0)
					throw new ModelException((String) success.get(common.RPCConstantsAndServices.ExceptionMessageFieldName),
							((Integer) success.get(common.RPCConstantsAndServices.ExceptionNumberFieldName)).intValue());
	...
	public synchronized void createEnum(final String name) throws ModelException {
		try {
			final Vector<Object> parameters = new Vector<Object>();
			parameters.add(name);
	...
	public synchronized void createObsType(final String name, final MEnumView enumType, final MTypeView theType) throws ModelException {
		try {
			final Vector<Object> parameters = new Vector<Object>();
			parameters.add(name);
	...
	public synchronized void createTypeConjunction(final java.util.Vector<MTypeView> containees) throws ModelException {
		try {
			final Vector<Object> parameters = new Vector<Object>();
	...
	public synchronized void createTypeDisjunction(final java.util.Vector<MTypeView> containees) throws ModelException {
		try {
			final Vector<Object> parameters = new Vector<Object>();
			final java.util.Vector<String> containeesTrnsprt = new java.util.Vector<String>();
			final java.util.Iterator<MTypeView> containeesItrtr = containees.iterator();
