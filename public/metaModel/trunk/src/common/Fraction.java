...
public class Fraction {
	...
	public static Fraction parse(String fraction) {
		...
		try {
			...
			String denominatorText = fraction.substring(fractionStrokePosition + FractionStroke.length(),
					fraction.length());
	...
	public String toString() {
		return this.getEnumerator().toString()
				+ (this.getDenominator().equals(BigInteger.ONE) ? "" : (FractionStroke + this.getDenominator()
						.toString()));
	}
	...
	public Fraction mul(Fraction fraction) throws Throwable {
		...
		Fraction result = new Fraction(frac1.enumerator.multiply(frac2.enumerator),
	...
	public Fraction add(Fraction fraction) throws Throwable {
		...
		Fraction result = new Fraction(fraction.enumerator.multiply(denominator).add(
				this.enumerator.multiply(fraction.denominator)), this.denominator.multiply(fraction.denominator));
		return result;
	}
