...
public class MEmptySumICProxi extends MSumTypeICProxi implements PersistentMEmptySum{
    
    public MEmptySumICProxi(long objectId) {
        super(objectId);
    }
    public MEmptySumICProxi(PersistentObject object) {
        super(object);
    }
