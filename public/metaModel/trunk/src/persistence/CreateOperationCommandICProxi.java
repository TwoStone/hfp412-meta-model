...
public class CreateOperationCommandICProxi extends PersistentInCacheProxi implements PersistentCreateOperationCommand{
    
    public CreateOperationCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateOperationCommandICProxi(PersistentObject object) {
        super(object);
    }
