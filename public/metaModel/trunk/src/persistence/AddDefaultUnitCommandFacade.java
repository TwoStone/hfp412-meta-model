...
public class AddDefaultUnitCommandFacade{
    ...
    public AddDefaultUnitCommandProxi newAddDefaultUnitCommand(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (AddDefaultUnitCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 110);
        ...
        return (AddDefaultUnitCommandProxi)PersistentProxi.createProxi(id, 110);
    }
    ...
    public void typeSet(long AddDefaultUnitCommandId, PersistentUnitType typeVal) throws PersistenceException {
        
    }
    public void unitSet(long AddDefaultUnitCommandId, PersistentUnit unitVal) throws PersistenceException {
