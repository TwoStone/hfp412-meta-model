...
public class CreateAssociationCommandProxi extends PersistentProxi implements PersistentCreateAssociationCommand{
    
    public CreateAssociationCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateAssociationCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
