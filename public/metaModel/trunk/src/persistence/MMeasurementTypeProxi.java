...
public class MMeasurementTypeProxi extends MQuantiObjectTypeProxi implements PersistentMMeasurementType{
    
    public MMeasurementTypeProxi(long objectId) {
        super(objectId);
    }
    public MMeasurementTypeProxi(PersistentInCacheProxi object) {
        super(object);
    }
