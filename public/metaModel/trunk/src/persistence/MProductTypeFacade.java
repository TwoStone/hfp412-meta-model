...
public class MProductTypeFacade{
    ...
    public MProductTypeProxi newMProductType(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (MProductTypeProxi)PersistentProxi.createProxi(createMinusStorePlus, 115);
        ...
        return (MProductTypeProxi)PersistentProxi.createProxi(id, 115);
    }
