...
public class CreateQuantityCommandICProxi extends PersistentInCacheProxi implements PersistentCreateQuantityCommand{
    
    public CreateQuantityCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateQuantityCommandICProxi(PersistentObject object) {
        super(object);
    }
