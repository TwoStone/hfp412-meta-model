...
public class RemoveAssoFrmHierCommandICProxi extends PersistentInCacheProxi implements PersistentRemoveAssoFrmHierCommand{
    
    public RemoveAssoFrmHierCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemoveAssoFrmHierCommandICProxi(PersistentObject object) {
        super(object);
    }
