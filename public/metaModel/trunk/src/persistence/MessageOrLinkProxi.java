...
public abstract class MessageOrLinkProxi extends PersistentProxi implements PersistentMessageOrLink{
    
    public MessageOrLinkProxi(long objectId) {
        super(objectId);
    }
    public MessageOrLinkProxi(PersistentInCacheProxi object) {
        super(object);
    }
