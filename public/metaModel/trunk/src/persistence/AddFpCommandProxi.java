...
public class AddFpCommandProxi extends PersistentProxi implements PersistentAddFpCommand{
    
    public AddFpCommandProxi(long objectId) {
        super(objectId);
    }
    public AddFpCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
