...
public class AddReferenceTypeCommandFacade{
    ...
    public AddReferenceTypeCommandProxi newAddReferenceTypeCommand(long exponent,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (AddReferenceTypeCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 193);
        ...
        return (AddReferenceTypeCommandProxi)PersistentProxi.createProxi(id, 193);
    }
