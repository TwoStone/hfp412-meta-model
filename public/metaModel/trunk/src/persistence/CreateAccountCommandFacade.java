...
public class CreateAccountCommandFacade{
    ...
    public CreateAccountCommandProxi newCreateAccountCommand(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateAccountCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 153);
        ...
        return (CreateAccountCommandProxi)PersistentProxi.createProxi(id, 153);
    }
