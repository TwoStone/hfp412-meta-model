...
public class CreateLinkCommandProxi extends PersistentProxi implements PersistentCreateLinkCommand{
    
    public CreateLinkCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateLinkCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
