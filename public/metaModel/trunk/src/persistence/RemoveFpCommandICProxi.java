...
public class RemoveFpCommandICProxi extends PersistentInCacheProxi implements PersistentRemoveFpCommand{
    
    public RemoveFpCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemoveFpCommandICProxi(PersistentObject object) {
        super(object);
    }
