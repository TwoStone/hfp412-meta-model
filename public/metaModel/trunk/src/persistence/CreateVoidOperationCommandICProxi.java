...
public class CreateVoidOperationCommandICProxi extends PersistentInCacheProxi implements PersistentCreateVoidOperationCommand{
    
    public CreateVoidOperationCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateVoidOperationCommandICProxi(PersistentObject object) {
        super(object);
    }
