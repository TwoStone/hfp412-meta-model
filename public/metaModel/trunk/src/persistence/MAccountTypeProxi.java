...
public class MAccountTypeProxi extends MQuantiObjectTypeProxi implements PersistentMAccountType{
    
    public MAccountTypeProxi(long objectId) {
        super(objectId);
    }
    public MAccountTypeProxi(PersistentInCacheProxi object) {
        super(object);
    }
