...
public class CreateMessageCommandICProxi extends PersistentInCacheProxi implements PersistentCreateMessageCommand{
    
    public CreateMessageCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateMessageCommandICProxi(PersistentObject object) {
        super(object);
    }
