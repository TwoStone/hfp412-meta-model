...
public class CreateConstantCommandICProxi extends PersistentInCacheProxi implements PersistentCreateConstantCommand{
    
    public CreateConstantCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateConstantCommandICProxi(PersistentObject object) {
        super(object);
    }
