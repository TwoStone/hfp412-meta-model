...
public abstract class MAbstractSumTypeProxi extends MComplexTypeProxi implements PersistentMAbstractSumType{
    
    public MAbstractSumTypeProxi(long objectId) {
        super(objectId);
    }
    public MAbstractSumTypeProxi(PersistentInCacheProxi object) {
        super(object);
    }
