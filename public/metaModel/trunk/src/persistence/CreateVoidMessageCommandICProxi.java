...
public class CreateVoidMessageCommandICProxi extends PersistentInCacheProxi implements PersistentCreateVoidMessageCommand{
    
    public CreateVoidMessageCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateVoidMessageCommandICProxi(PersistentObject object) {
        super(object);
    }
