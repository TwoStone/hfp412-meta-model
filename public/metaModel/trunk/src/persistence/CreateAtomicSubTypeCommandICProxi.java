...
public class CreateAtomicSubTypeCommandICProxi extends PersistentInCacheProxi implements PersistentCreateAtomicSubTypeCommand{
    
    public CreateAtomicSubTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateAtomicSubTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
