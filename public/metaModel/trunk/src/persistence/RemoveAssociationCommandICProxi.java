...
public class RemoveAssociationCommandICProxi extends PersistentInCacheProxi implements PersistentRemoveAssociationCommand{
    
    public RemoveAssociationCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemoveAssociationCommandICProxi(PersistentObject object) {
        super(object);
    }
