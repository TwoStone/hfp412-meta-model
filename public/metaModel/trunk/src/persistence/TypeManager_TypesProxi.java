...
public class TypeManager_TypesProxi extends PersistentListProxi<PersistentMType> {

  private MTypeList list;
  private TypeManager owner;

  public TypeManager_TypesProxi(TypeManager owner) {
    this.owner = owner;
  }
      ...
      if (this.owner.isDelayed$Persistence()) {
        ...
        this.list = ConnectionHandler
                    .getTheConnectionHandler()
                      .theTypeManagerFacade.typesGet(this.owner.getId());
      }
    }
    return this.list;
  }
  ...
  protected void remove(PersistentListEntryProxi entry) throws PersistenceException {
    if (!this.owner.isDelayed$Persistence()) {
      ConnectionHandler.getTheConnectionHandler().theTypeManagerFacade.typesRem(entry.getListEntryId());
    }
    
  }
  public TypeManager_TypesProxi copy(TypeManager owner) throws PersistenceException {
  	TypeManager_TypesProxi result = new TypeManager_TypesProxi(owner);
