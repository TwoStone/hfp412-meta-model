...
public class CreateAtomicTypeCommandProxi extends PersistentProxi implements PersistentCreateAtomicTypeCommand{
    
    public CreateAtomicTypeCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateAtomicTypeCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
