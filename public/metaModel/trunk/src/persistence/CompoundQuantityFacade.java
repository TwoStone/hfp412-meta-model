...
public class CompoundQuantityFacade{
    ...
    public CompoundQuantityProxi newCompoundQuantity(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CompoundQuantityProxi)PersistentProxi.createProxi(createMinusStorePlus, 108);
        ...
        return (CompoundQuantityProxi)PersistentProxi.createProxi(id, 108);
    }
