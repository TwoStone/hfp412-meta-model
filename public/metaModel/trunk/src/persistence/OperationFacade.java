...
public class OperationFacade{
    ...
    public OperationProxi newOperation(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (OperationProxi)PersistentProxi.createProxi(createMinusStorePlus, 231);
        ...
        return (OperationProxi)PersistentProxi.createProxi(id, 231);
    }
