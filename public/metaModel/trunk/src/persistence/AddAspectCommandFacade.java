...
public class AddAspectCommandFacade{
    ...
    public AddAspectCommandProxi newAddAspectCommand(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (AddAspectCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 125);
    ...
    public AddAspectCommandProxi newDelayedAddAspectCommand(String name) throws PersistenceException {
        long id = ConnectionHandler.getTheConnectionHandler().theAddAspectCommandFacade.getNextId();
        AddAspectCommand result = new AddAspectCommand(name,null,null,null,id);
        Cache.getTheCache().put(result);
        return (AddAspectCommandProxi)PersistentProxi.createProxi(id, 125);
