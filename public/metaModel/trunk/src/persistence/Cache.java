...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(241, "AddAssociationCommand");
		this.number2NameMap.put(177, "AddDefaultUnitCommand");
		this.number2NameMap.put(237, "AddFpCommand");
		...
		this.number2NameMap.put(223, "Association");
		...
		this.number2NameMap.put(188, "CreateAtomicSubTypeCommand");
		this.number2NameMap.put(174, "CreateCompUnitCommand");
		this.number2NameMap.put(175, "CreateCompUnitTypeCommand");
		this.number2NameMap.put(242, "CreateConstCommand");
		this.number2NameMap.put(229, "CreateConstantCommand");
		...
		this.number2NameMap.put(238, "CreateStaticMessageCommand");
		this.number2NameMap.put(232, "CreateStaticOpCommand");
		...
		this.number2NameMap.put(240, "CreateVoidMessageCommand");
		this.number2NameMap.put(233, "CreateVoidOperationCommand");
		this.number2NameMap.put(-104, "ErrorDisplay");
		this.number2NameMap.put(179, "FinishModelingCommand");
		this.number2NameMap.put(225, "FormalParameter");
		this.number2NameMap.put(178, "FractionManager");
		this.number2NameMap.put(159, "Function");
		this.number2NameMap.put(236, "Hierarchy");
		this.number2NameMap.put(203, "InstanceObject");
		this.number2NameMap.put(207, "Link");
		this.number2NameMap.put(244, "LinkManager");
		this.number2NameMap.put(192, "MAbstractProductType");
		this.number2NameMap.put(194, "MAccountType");
		...
		this.number2NameMap.put(222, "RemoveAssoFrmHierCommand");
		this.number2NameMap.put(235, "RemoveAssociationCommand");
		this.number2NameMap.put(227, "RemoveFpCommand");
		this.number2NameMap.put(245, "RemoveFpFromOpCommand");
		this.number2NameMap.put(224, "RemoveLinkCommand");
		this.number2NameMap.put(246, "RemoveMessageCommand");
		this.number2NameMap.put(228, "RemoveOperationCommand");
