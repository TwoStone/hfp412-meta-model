...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(183, "Account");
		this.number2NameMap.put(143, "AccountManager");
		this.number2NameMap.put(129, "AccountTypeManager");
		this.number2NameMap.put(196, "ActualParameter");
		this.number2NameMap.put(175, "AddAssociationCommand");
		this.number2NameMap.put(110, "AddDefaultUnitCommand");
		this.number2NameMap.put(167, "AddFpCommand");
		this.number2NameMap.put(195, "AddReferenceTypeCommand");
		this.number2NameMap.put(138, "AspectManager");
		this.number2NameMap.put(117, "Association");
		this.number2NameMap.put(154, "AssociationManager");
		this.number2NameMap.put(-128, "CommandCoordinator");
		this.number2NameMap.put(-193, "CommandExecuter");
		this.number2NameMap.put(162, "CommonDate");
		this.number2NameMap.put(145, "CompUnit");
		this.number2NameMap.put(114, "CompUnitType");
		this.number2NameMap.put(109, "CompoundQuantity");
		this.number2NameMap.put(179, "Conversion");
		this.number2NameMap.put(149, "ConversionManager");
		this.number2NameMap.put(155, "CreateAccountCommand");
		this.number2NameMap.put(147, "CreateAccountTypeCommand");
		this.number2NameMap.put(105, "CreateAspectCommand");
		this.number2NameMap.put(189, "CreateAssociationCommand");
		this.number2NameMap.put(191, "CreateAtomicRootTypeCommand");
		this.number2NameMap.put(157, "CreateAtomicSubTypeCommand");
		this.number2NameMap.put(161, "CreateCompUnitCommand");
		this.number2NameMap.put(163, "CreateCompUnitTypeCommand");
		this.number2NameMap.put(176, "CreateConstCommand");
		this.number2NameMap.put(140, "CreateConstantCommand");
		this.number2NameMap.put(156, "CreateConversionCommand");
		this.number2NameMap.put(201, "CreateFpCommand");
		this.number2NameMap.put(120, "CreateHierarchyCommand");
		this.number2NameMap.put(160, "CreateLinkCommand");
		this.number2NameMap.put(101, "CreateMObjectCommand");
		this.number2NameMap.put(125, "CreateMeasurementTypeCommand");
		this.number2NameMap.put(146, "CreateMessageCommand");
		this.number2NameMap.put(178, "CreateOperationCommand");
		this.number2NameMap.put(152, "CreateProductTypeCommand");
		this.number2NameMap.put(131, "CreateQuantityCommand");
		this.number2NameMap.put(168, "CreateStaticMessageCommand");
		this.number2NameMap.put(153, "CreateStaticOpCommand");
		this.number2NameMap.put(197, "CreateSumTypeCommand");
		this.number2NameMap.put(106, "CreateUnitCommand");
		this.number2NameMap.put(102, "CreateUnitTypeCommand");
		this.number2NameMap.put(173, "CreateVoidMessageCommand");
		this.number2NameMap.put(159, "CreateVoidOperationCommand");
		this.number2NameMap.put(-123, "ErrorDisplay");
		this.number2NameMap.put(181, "FinishModelingCommand");
		this.number2NameMap.put(119, "FormalParameter");
		this.number2NameMap.put(177, "FractionManager");
		this.number2NameMap.put(137, "Function");
		this.number2NameMap.put(165, "Hierarchy");
		...
		this.number2NameMap.put(130, "MObject");
		this.number2NameMap.put(115, "MProductType");
		this.number2NameMap.put(144, "MSumType");
		this.number2NameMap.put(192, "MTrue");
		this.number2NameMap.put(116, "Measurement");
		this.number2NameMap.put(186, "MeasurementTypeManager");
		this.number2NameMap.put(135, "Message");
		this.number2NameMap.put(170, "MessageManager");
		this.number2NameMap.put(200, "ObjectManager");
		this.number2NameMap.put(148, "Operation");
		this.number2NameMap.put(121, "OperationManager");
		this.number2NameMap.put(194, "Quantity");
		this.number2NameMap.put(150, "QuantityManager");
		this.number2NameMap.put(180, "Reference");
		this.number2NameMap.put(182, "ReferenceType");
		this.number2NameMap.put(111, "RemoveAssoFrmHierCommand");
		this.number2NameMap.put(164, "RemoveAssociationCommand");
		this.number2NameMap.put(133, "RemoveFpCommand");
		this.number2NameMap.put(198, "RemoveFpFromOpCommand");
		this.number2NameMap.put(118, "RemoveLinkCommand");
		this.number2NameMap.put(199, "RemoveMessageCommand");
		this.number2NameMap.put(139, "RemoveOperationCommand");
		this.number2NameMap.put(-112, "Server");
		this.number2NameMap.put(169, "TypeManager");
		this.number2NameMap.put(124, "Unit");
		this.number2NameMap.put(184, "UnitType");
		this.number2NameMap.put(171, "UnitTypeManager");	
	}
