...
public class InstanceObjectICProxi extends PersistentInCacheProxiOptimistic implements PersistentInstanceObject{
    
    public InstanceObjectICProxi(long objectId) {
        super(objectId);
    }
    public InstanceObjectICProxi(PersistentObject object) {
        super(object);
    }
