...
public class CreateMObjectCommandFacade{
    ...
    public CreateMObjectCommandProxi newCreateMObjectCommand(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateMObjectCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 235);
        ...
        return (CreateMObjectCommandProxi)PersistentProxi.createProxi(id, 235);
    }
