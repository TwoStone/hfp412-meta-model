...
public class CreateAspectCommandFacade{
    ...
    public CreateAspectCommand getCreateAspectCommand(long CreateAspectCommandId) throws PersistenceException{
        try{
            ...
            PersistentMAspect commandResult = null;
            if (obj.getLong(7) != 0)
                commandResult = (PersistentMAspect)PersistentProxi.createProxi(obj.getLong(7), obj.getLong(8));
    ...
    public void commandResultSet(long CreateAspectCommandId, PersistentMAspect commandResultVal) throws PersistenceException {
        try{
            CallableStatement callable;
            callable = this.con.prepareCall("Begin " + this.schemaName + ".CrtAspctCMDFacade.cResultSet(?, ?, ?); end;");
            callable.setLong(1, CreateAspectCommandId);
