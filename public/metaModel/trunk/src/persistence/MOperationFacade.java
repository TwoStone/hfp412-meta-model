...
public class MOperationFacade{
    ...
    public MOperationProxi newMOperation(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (MOperationProxi)PersistentProxi.createProxi(createMinusStorePlus, 190);
        ...
        return (MOperationProxi)PersistentProxi.createProxi(id, 190);
    }
