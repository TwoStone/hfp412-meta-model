...
public abstract class AbsOperationProxi extends PersistentProxi implements PersistentAbsOperation{
    
    public AbsOperationProxi(long objectId) {
        super(objectId);
    }
    public AbsOperationProxi(PersistentInCacheProxi object) {
        super(object);
    }
