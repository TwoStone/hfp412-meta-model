...
public class MessageManagerProxi extends PersistentProxi implements PersistentMessageManager{
    
    public MessageManagerProxi(long objectId) {
        super(objectId);
    }
    public MessageManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
