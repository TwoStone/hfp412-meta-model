...
public class InstanceObjectFacade{
    ...
    public InstanceObjectProxi newInstanceObject(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (InstanceObjectProxi)PersistentProxi.createProxi(createMinusStorePlus, 205);
        ...
        return (InstanceObjectProxi)PersistentProxi.createProxi(id, 205);
    }
