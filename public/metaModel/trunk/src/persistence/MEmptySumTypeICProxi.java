...
public class MEmptySumTypeICProxi extends MAbstractSumTypeICProxi implements PersistentMEmptySumType{
    
    public MEmptySumTypeICProxi(long objectId) {
        super(objectId);
    }
    public MEmptySumTypeICProxi(PersistentObject object) {
        super(object);
    }
