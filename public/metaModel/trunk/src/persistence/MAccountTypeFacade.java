...
public class MAccountTypeFacade{
    ...
    public MAccountTypeProxi newMAccountType(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (MAccountTypeProxi)PersistentProxi.createProxi(createMinusStorePlus, 164);
        ...
        return (MAccountTypeProxi)PersistentProxi.createProxi(id, 164);
    }
