...
public class AddAtomicTypeCommandFacade{
    ...
    public AddAtomicTypeCommandProxi newAddAtomicTypeCommand(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (AddAtomicTypeCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 122);
    ...
    public AddAtomicTypeCommandProxi newDelayedAddAtomicTypeCommand(String name) throws PersistenceException {
        long id = ConnectionHandler.getTheConnectionHandler().theAddAtomicTypeCommandFacade.getNextId();
        AddAtomicTypeCommand result = new AddAtomicTypeCommand(null,name,null,null,null,id);
        Cache.getTheCache().put(result);
        return (AddAtomicTypeCommandProxi)PersistentProxi.createProxi(id, 122);
