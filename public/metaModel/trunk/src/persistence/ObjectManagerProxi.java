...
public class ObjectManagerProxi extends PersistentProxi implements PersistentObjectManager{
    
    public ObjectManagerProxi(long objectId) {
        super(objectId);
    }
    public ObjectManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
