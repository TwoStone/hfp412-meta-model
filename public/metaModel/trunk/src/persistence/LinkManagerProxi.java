...
public class LinkManagerProxi extends PersistentProxi implements PersistentLinkManager{
    
    public LinkManagerProxi(long objectId) {
        super(objectId);
    }
    public LinkManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
