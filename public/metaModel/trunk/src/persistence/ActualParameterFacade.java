...
public class ActualParameterFacade{
    ...
    public ActualParameterProxi newActualParameter(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (ActualParameterProxi)PersistentProxi.createProxi(createMinusStorePlus, 206);
        ...
        return (ActualParameterProxi)PersistentProxi.createProxi(id, 206);
    }
