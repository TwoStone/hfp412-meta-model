...
public class CreateConversionCommandProxi extends PersistentProxi implements PersistentCreateConversionCommand{
    
    public CreateConversionCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateConversionCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
