...
public class ReferenceFacade{
    ...
    public ReferenceProxi newReference(long exponent,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (ReferenceProxi)PersistentProxi.createProxi(createMinusStorePlus, 163);
        ...
        return (ReferenceProxi)PersistentProxi.createProxi(id, 163);
    }
