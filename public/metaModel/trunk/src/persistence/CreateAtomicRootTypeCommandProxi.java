...
public class CreateAtomicRootTypeCommandProxi extends PersistentProxi implements PersistentCreateAtomicRootTypeCommand{
    
    public CreateAtomicRootTypeCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateAtomicRootTypeCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
