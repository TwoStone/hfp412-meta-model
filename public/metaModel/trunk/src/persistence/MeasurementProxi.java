...
public class MeasurementProxi extends QuantifObjectProxi implements PersistentMeasurement{
    
    public MeasurementProxi(long objectId) {
        super(objectId);
    }
    public MeasurementProxi(PersistentInCacheProxi object) {
        super(object);
    }
