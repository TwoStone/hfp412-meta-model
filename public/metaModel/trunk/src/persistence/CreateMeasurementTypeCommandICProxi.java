...
public class CreateMeasurementTypeCommandICProxi extends PersistentInCacheProxi implements PersistentCreateMeasurementTypeCommand{
    
    public CreateMeasurementTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateMeasurementTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
