...
public class CreateAtomicSubTypeCommandFacade{
    ...
    public CreateAtomicSubTypeCommandProxi newCreateAtomicSubTypeCommand(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateAtomicSubTypeCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 155);
        ...
        return (CreateAtomicSubTypeCommandProxi)PersistentProxi.createProxi(id, 155);
    }
