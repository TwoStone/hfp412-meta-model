...
public class MFormalParameterICProxi extends PersistentInCacheProxiOptimistic implements PersistentMFormalParameter{
    
    public MFormalParameterICProxi(long objectId) {
        super(objectId);
    }
    public MFormalParameterICProxi(PersistentObject object) {
        super(object);
    }
