...
public class CreateConstCommandProxi extends PersistentProxi implements PersistentCreateConstCommand{
    
    public CreateConstCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateConstCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
