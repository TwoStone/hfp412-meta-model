...
public class MOperationProxi extends MAbsOperationProxi implements PersistentMOperation{
    
    public MOperationProxi(long objectId) {
        super(objectId);
    }
    public MOperationProxi(PersistentInCacheProxi object) {
        super(object);
    }
