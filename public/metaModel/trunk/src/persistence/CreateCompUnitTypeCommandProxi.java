...
public class CreateCompUnitTypeCommandProxi extends PersistentProxi implements PersistentCreateCompUnitTypeCommand{
    
    public CreateCompUnitTypeCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateCompUnitTypeCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
