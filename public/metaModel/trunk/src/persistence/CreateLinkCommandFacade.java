...
public class CreateLinkCommandFacade{
    ...
    public CreateLinkCommandProxi newCreateLinkCommand(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateLinkCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 234);
        ...
        return (CreateLinkCommandProxi)PersistentProxi.createProxi(id, 234);
    }
