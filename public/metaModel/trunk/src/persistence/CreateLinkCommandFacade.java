...
public class CreateLinkCommandFacade{
    ...
    public CreateLinkCommandProxi newCreateLinkCommand(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateLinkCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 158);
        ...
        return (CreateLinkCommandProxi)PersistentProxi.createProxi(id, 158);
    }
