...
public class OperationManagerProxi extends PersistentProxi implements PersistentOperationManager{
    
    public OperationManagerProxi(long objectId) {
        super(objectId);
    }
    public OperationManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
