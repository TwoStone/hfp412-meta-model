...
public abstract class MAbsOperationICProxi extends PersistentInCacheProxiOptimistic implements PersistentMAbsOperation{
    
    public MAbsOperationICProxi(long objectId) {
        super(objectId);
    }
    public MAbsOperationICProxi(PersistentObject object) {
        super(object);
    }
