...
public class RemoveOperationCommandProxi extends PersistentProxi implements PersistentRemoveOperationCommand{
    
    public RemoveOperationCommandProxi(long objectId) {
        super(objectId);
    }
    public RemoveOperationCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
