...
public class AddAspectCommandICProxi extends PersistentInCacheProxi implements PersistentAddAspectCommand{
    
    public AddAspectCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddAspectCommandICProxi(PersistentObject object) {
        super(object);
    }
