...
public class MFalseProxi extends MBooleanProxi implements PersistentMFalse{
    
    public MFalseProxi(long objectId) {
        super(objectId);
    }
    public MFalseProxi(PersistentInCacheProxi object) {
        super(object);
    }
