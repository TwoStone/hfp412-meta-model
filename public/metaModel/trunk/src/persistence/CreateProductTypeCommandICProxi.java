...
public class CreateProductTypeCommandICProxi extends PersistentInCacheProxi implements PersistentCreateProductTypeCommand{
    
    public CreateProductTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateProductTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
