...
public class CreateAccountTypeCommandICProxi extends PersistentInCacheProxi implements PersistentCreateAccountTypeCommand{
    
    public CreateAccountTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateAccountTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
