...
public class MObjectProxi extends PersistentProxi implements PersistentMObject{
    
    public MObjectProxi(long objectId) {
        super(objectId);
    }
    public MObjectProxi(PersistentInCacheProxi object) {
        super(object);
    }
