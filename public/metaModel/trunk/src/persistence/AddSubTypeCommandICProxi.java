...
public class AddSubTypeCommandICProxi extends PersistentInCacheProxi implements PersistentAddSubTypeCommand{
    
    public AddSubTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddSubTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
