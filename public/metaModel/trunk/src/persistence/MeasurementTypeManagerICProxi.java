...
public class MeasurementTypeManagerICProxi extends PersistentInCacheProxiOptimistic implements PersistentMeasurementTypeManager{
    
    public MeasurementTypeManagerICProxi(long objectId) {
        super(objectId);
    }
    public MeasurementTypeManagerICProxi(PersistentObject object) {
        super(object);
    }
