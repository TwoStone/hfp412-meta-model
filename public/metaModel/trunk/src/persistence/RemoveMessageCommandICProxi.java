...
public class RemoveMessageCommandICProxi extends PersistentInCacheProxi implements PersistentRemoveMessageCommand{
    
    public RemoveMessageCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemoveMessageCommandICProxi(PersistentObject object) {
        super(object);
    }
