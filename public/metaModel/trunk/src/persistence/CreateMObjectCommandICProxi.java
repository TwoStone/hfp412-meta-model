...
public class CreateMObjectCommandICProxi extends PersistentInCacheProxi implements PersistentCreateMObjectCommand{
    
    public CreateMObjectCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateMObjectCommandICProxi(PersistentObject object) {
        super(object);
    }
