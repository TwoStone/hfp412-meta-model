...
public class CreateAssociationCommandFacade{
    ...
    public CreateAssociationCommandProxi newCreateAssociationCommand(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateAssociationCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 189);
        ...
        return (CreateAssociationCommandProxi)PersistentProxi.createProxi(id, 189);
    }
