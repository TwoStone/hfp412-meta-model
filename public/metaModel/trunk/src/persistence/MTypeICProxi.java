...
public abstract class MTypeICProxi extends PersistentInCacheProxiOptimistic implements PersistentMType{
    
    public MTypeICProxi(long objectId) {
        super(objectId);
    }
    public MTypeICProxi(PersistentObject object) {
        super(object);
    }
    ...
    public PersistentMBoolean isLessOrEqual(final PersistentMType other) 
				throws PersistenceException{
        return ((PersistentMType)this.getTheObject()).isLessOrEqual(other);
    }
