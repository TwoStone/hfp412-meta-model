...
public class FormalParameterProxi extends PersistentProxi implements PersistentFormalParameter{
    
    public FormalParameterProxi(long objectId) {
        super(objectId);
    }
    public FormalParameterProxi(PersistentInCacheProxi object) {
        super(object);
    }
