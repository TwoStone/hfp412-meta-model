...
public abstract class MQuantiObjectTypeICProxi extends PersistentInCacheProxiOptimistic implements PersistentMQuantiObjectType{
    
    public MQuantiObjectTypeICProxi(long objectId) {
        super(objectId);
    }
    public MQuantiObjectTypeICProxi(PersistentObject object) {
        super(object);
    }
