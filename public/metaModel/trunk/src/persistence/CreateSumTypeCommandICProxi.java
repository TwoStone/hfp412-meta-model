...
public class CreateSumTypeCommandICProxi extends PersistentInCacheProxi implements PersistentCreateSumTypeCommand{
    
    public CreateSumTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateSumTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
