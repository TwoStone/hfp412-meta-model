...
public class AddAssociationCommandICProxi extends PersistentInCacheProxi implements PersistentAddAssociationCommand{
    
    public AddAssociationCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddAssociationCommandICProxi(PersistentObject object) {
        super(object);
    }
