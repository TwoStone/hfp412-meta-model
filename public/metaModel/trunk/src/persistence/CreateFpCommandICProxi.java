...
public class CreateFpCommandICProxi extends PersistentInCacheProxi implements PersistentCreateFpCommand{
    
    public CreateFpCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateFpCommandICProxi(PersistentObject object) {
        super(object);
    }
