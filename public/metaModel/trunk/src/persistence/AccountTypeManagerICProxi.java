...
public class AccountTypeManagerICProxi extends PersistentInCacheProxiOptimistic implements PersistentAccountTypeManager{
    
    public AccountTypeManagerICProxi(long objectId) {
        super(objectId);
    }
    public AccountTypeManagerICProxi(PersistentObject object) {
        super(object);
    }
