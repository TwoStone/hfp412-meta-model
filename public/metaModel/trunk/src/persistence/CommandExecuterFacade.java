...
public class CommandExecuterFacade{
    ...
    public CommandExecuterProxi newCommandExecuter(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CommandExecuterProxi)PersistentProxi.createProxi(createMinusStorePlus, -191);
        ...
        return (CommandExecuterProxi)PersistentProxi.createProxi(id, -191);
    }
