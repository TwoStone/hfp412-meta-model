...
public class QuantityFacade{
    ...
    public QuantityProxi newQuantity(common.Fraction amount,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (QuantityProxi)PersistentProxi.createProxi(createMinusStorePlus, 194);
        ...
        return (QuantityProxi)PersistentProxi.createProxi(id, 194);
    }
    ...
    public void unitSet(long QuantityId, PersistentAbsUnit unitVal) throws PersistenceException {
