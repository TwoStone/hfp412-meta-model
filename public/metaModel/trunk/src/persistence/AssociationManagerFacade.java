...
public class AssociationManagerFacade{
    ...
    public AssociationManagerProxi getTheAssociationManager() throws PersistenceException {
        ...
        try{
            ...
            callable.close();
            return (AssociationManagerProxi)PersistentProxi.createProxi(id, 154);
    ...
    public AssociationList associationsGet(long AssociationManagerId) throws PersistenceException {
        try{
            ...
            while (list.next()) {
                result.add((PersistentAssociation)PersistentProxi.createListEntryProxi(list.getLong(1), list.getLong(2), list.getLong(3)));
            }
            list.close();
            callable.close();
            return result;
