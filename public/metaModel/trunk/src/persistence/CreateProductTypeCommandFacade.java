...
public class CreateProductTypeCommandFacade{
    ...
    public CreateProductTypeCommandProxi newCreateProductTypeCommand(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateProductTypeCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 150);
        ...
        return (CreateProductTypeCommandProxi)PersistentProxi.createProxi(id, 150);
    }
