...
public class CreateHierarchyCommandICProxi extends PersistentInCacheProxi implements PersistentCreateHierarchyCommand{
    
    public CreateHierarchyCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateHierarchyCommandICProxi(PersistentObject object) {
        super(object);
    }
