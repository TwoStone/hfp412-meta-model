...
public class AddAssociationCommandFacade{
    ...
    public AddAssociationCommandProxi newAddAssociationCommand(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (AddAssociationCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 241);
        ...
        return (AddAssociationCommandProxi)PersistentProxi.createProxi(id, 241);
    }
