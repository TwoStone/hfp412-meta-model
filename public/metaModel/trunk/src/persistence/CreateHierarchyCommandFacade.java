...
public class CreateHierarchyCommandFacade{
    ...
    public CreateHierarchyCommandProxi newCreateHierarchyCommand(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateHierarchyCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 119);
        ...
        return (CreateHierarchyCommandProxi)PersistentProxi.createProxi(id, 119);
    }
