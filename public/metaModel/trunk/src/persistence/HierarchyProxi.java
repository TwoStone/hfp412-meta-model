...
public class HierarchyProxi extends PersistentProxi implements PersistentHierarchy{
    
    public HierarchyProxi(long objectId) {
        super(objectId);
    }
    public HierarchyProxi(PersistentInCacheProxi object) {
        super(object);
    }
