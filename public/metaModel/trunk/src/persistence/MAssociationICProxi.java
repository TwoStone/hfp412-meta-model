...
public class MAssociationICProxi extends PersistentInCacheProxiOptimistic implements PersistentMAssociation{
    
    public MAssociationICProxi(long objectId) {
        super(objectId);
    }
    public MAssociationICProxi(PersistentObject object) {
        super(object);
    }
