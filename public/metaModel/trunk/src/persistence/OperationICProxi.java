...
public class OperationICProxi extends AbsOperationICProxi implements PersistentOperation{
    
    public OperationICProxi(long objectId) {
        super(objectId);
    }
    public OperationICProxi(PersistentObject object) {
        super(object);
    }
