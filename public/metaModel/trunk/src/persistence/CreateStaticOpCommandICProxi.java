...
public class CreateStaticOpCommandICProxi extends PersistentInCacheProxi implements PersistentCreateStaticOpCommand{
    
    public CreateStaticOpCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateStaticOpCommandICProxi(PersistentObject object) {
        super(object);
    }
