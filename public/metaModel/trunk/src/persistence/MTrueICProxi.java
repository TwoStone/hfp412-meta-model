...
public class MTrueICProxi extends MBooleanICProxi implements PersistentMTrue{
    
    public MTrueICProxi(long objectId) {
        super(objectId);
    }
    public MTrueICProxi(PersistentObject object) {
        super(object);
    }
