...
public class AddAtomicTypeCommandICProxi extends PersistentInCacheProxi implements PersistentAddAtomicTypeCommand{
    
    public AddAtomicTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddAtomicTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
