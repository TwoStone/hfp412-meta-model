...
public class MMeasurementTypeFacade{
    ...
    public MMeasurementTypeProxi newMMeasurementType(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (MMeasurementTypeProxi)PersistentProxi.createProxi(createMinusStorePlus, 125);
        ...
        return (MMeasurementTypeProxi)PersistentProxi.createProxi(id, 125);
    }
