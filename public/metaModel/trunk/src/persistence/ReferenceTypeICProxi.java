...
public class ReferenceTypeICProxi extends PersistentInCacheProxiOptimistic implements PersistentReferenceType{
    
    public ReferenceTypeICProxi(long objectId) {
        super(objectId);
    }
    public ReferenceTypeICProxi(PersistentObject object) {
        super(object);
    }
