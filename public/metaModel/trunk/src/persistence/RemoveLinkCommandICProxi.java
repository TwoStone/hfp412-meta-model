...
public class RemoveLinkCommandICProxi extends PersistentInCacheProxi implements PersistentRemoveLinkCommand{
    
    public RemoveLinkCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemoveLinkCommandICProxi(PersistentObject object) {
        super(object);
    }
