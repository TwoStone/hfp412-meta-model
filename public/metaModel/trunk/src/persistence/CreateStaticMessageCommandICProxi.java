...
public class CreateStaticMessageCommandICProxi extends PersistentInCacheProxi implements PersistentCreateStaticMessageCommand{
    
    public CreateStaticMessageCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateStaticMessageCommandICProxi(PersistentObject object) {
        super(object);
    }
