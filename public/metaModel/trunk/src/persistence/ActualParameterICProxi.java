...
public class ActualParameterICProxi extends PersistentInCacheProxiOptimistic implements PersistentActualParameter{
    
    public ActualParameterICProxi(long objectId) {
        super(objectId);
    }
    public ActualParameterICProxi(PersistentObject object) {
        super(object);
    }
