...
public class AspectManagerFacade{
    ...
    public AspectManagerProxi getTheAspectManager() throws PersistenceException {
        ...
        try{
            ...
            callable.close();
            return (AspectManagerProxi)PersistentProxi.createProxi(id, 138);
    ...
    public MAspectList aspectsGet(long AspectManagerId) throws PersistenceException {
        try{
            ...
            while (list.next()) {
                result.add((PersistentMAspect)PersistentProxi.createListEntryProxi(list.getLong(1), list.getLong(2), list.getLong(3)));
            }
            list.close();
            callable.close();
            return result;
