...
public class MEmptyProductTypeICProxi extends MAbstractProductTypeICProxi implements PersistentMEmptyProductType{
    
    public MEmptyProductTypeICProxi(long objectId) {
        super(objectId);
    }
    public MEmptyProductTypeICProxi(PersistentObject object) {
        super(object);
    }
