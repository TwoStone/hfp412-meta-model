...
public class NotFoundException extends model.UserException{
    ...
    public NotFoundException(String message) throws persistence.PersistenceException {
        super(message);        
    }
