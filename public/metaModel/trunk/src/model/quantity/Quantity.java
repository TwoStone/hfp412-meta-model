...
public class Quantity extends model.quantity.AbsQuantity implements PersistentQuantity{
    ...
    public CompoundQuantitySearchList inverseGetParts() 
				throws PersistenceException{
        CompoundQuantitySearchList result = null;
		if (result == null) result = ConnectionHandler.getTheConnectionHandler().theCompoundQuantityFacade
							.inverseGetParts(this.getId(), this.getClassId());
		return result;
    }
