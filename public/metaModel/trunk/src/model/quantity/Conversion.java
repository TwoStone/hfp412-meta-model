...
public class Conversion extends PersistentObject implements PersistentConversion {
	...
	public static PersistentConversion createConversion(PersistentUnit source, PersistentFunction myFunction)
	...
	public static PersistentConversion createConversion(PersistentUnit source, PersistentFunction myFunction,
			boolean delayed$Persistence, PersistentConversion This) throws PersistenceException {
		PersistentConversion result = null;
		if (delayed$Persistence) {
			result = ConnectionHandler.getTheConnectionHandler().theConversionFacade.newDelayedConversion();
			result.setDelayed$Persistence(true);
	...
	public java.util.Hashtable<String, Object> toHashtable(java.util.Hashtable<String, Object> allResults, int depth,
		...
		if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth) {
			...
			AbstractPersistentRoot myFunction = this.getMyFunction();
			if (myFunction != null) {
	...
	public Conversion provideCopy() throws PersistenceException {
		...
		result = new Conversion(this.source, this.myFunction, this.This, this.getId());
	...
	public Conversion(PersistentUnit source, PersistentFunction myFunction, PersistentConversion This, long id)
	...
	public void store() throws PersistenceException {
		...
		if (this.getMyFunction() != null) {
			...
			ConnectionHandler.getTheConnectionHandler().theConversionFacade
					.myFunctionSet(this.getId(), getMyFunction());
		}
	...
	public int getLeafInfo() throws PersistenceException {
		return 0 + (this.getSource() == null ? 0 : 1) + (this.getMyFunction() == null ? 0 : 1);
	}

	@Override
	public PersistentQuantity convert(final common.Fraction amount) throws PersistenceException {
	...
	@Override
	public PersistentQuantity convertInverse(final common.Fraction amount) throws PersistenceException {
