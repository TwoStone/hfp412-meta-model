...
public class ReferenceType extends PersistentObject implements PersistentReferenceType {
	...
	public static PersistentReferenceType createReferenceType(long exponent, PersistentUnitType ref)
	...
	public static PersistentReferenceType createReferenceType(long exponent, PersistentUnitType ref,
			boolean delayed$Persistence, PersistentReferenceType This) throws PersistenceException {
		PersistentReferenceType result = null;
		if (delayed$Persistence) {
			result = ConnectionHandler.getTheConnectionHandler().theReferenceTypeFacade
					.newDelayedReferenceType(exponent);
	...
	public ReferenceType provideCopy() throws PersistenceException {
		...
		result = new ReferenceType(this.exponent, this.ref, this.This, this.getId());
	...
	public ReferenceType(long exponent, PersistentUnitType ref, PersistentReferenceType This, long id)
	...
	public CompUnitTypeSearchList inverseGetRefs() throws PersistenceException {
		...
		if (result == null)
			result = ConnectionHandler.getTheConnectionHandler().theCompUnitTypeFacade.inverseGetRefs(this.getId(),
					this.getClassId());
		return result;
	}
