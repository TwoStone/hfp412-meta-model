...
public abstract class AbsUnitType extends PersistentObject implements PersistentAbsUnitType {
	...
	public static AbsUnitTypeSearchList getAbsUnitTypeByName(String name) throws PersistenceException {
		return ConnectionHandler.getTheConnectionHandler().theAbsUnitTypeFacade.getAbsUnitTypeByName(name);
	}
	...
	@Override
	public AbsUnitSearchList inverseGetType() throws PersistenceException {
		AbsUnitSearchList result = null;
		if (result == null)
			result = ConnectionHandler.getTheConnectionHandler().theAbsUnitFacade.inverseGetType(this.getId(),
					this.getClassId());
		return result;
	}
