...
public class ConversionManager extends PersistentObject implements PersistentConversionManager {
			...
			class Initializer implements Runnable {
				...
				public void run() {
					try {
						...
						synchronized ($$lock) {
							proxi = ConnectionHandler.getTheConnectionHandler().theConversionManagerFacade
									.getTheConversionManager();
	...
	public java.util.Hashtable<String, Object> toHashtable(java.util.Hashtable<String, Object> allResults, int depth,
		...
		if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth) {
			...
			result.put("conversions",
					this.getConversions().getVector(allResults, depth, essentialLevel, forGUI, tdObserver, false));
	...
	public ConversionManager provideCopy() throws PersistenceException {
		...
		result = new ConversionManager(this.This, this.getId());
	...
	public int getLeafInfo() throws PersistenceException {
		return (int) (0 + this.getConversions().getLength());
	}
	...
	public void createConversion(final PersistentUnit unit, final common.Fraction factor, final common.Fraction constant)
		...
		getThis().getConversions().add(Conversion.createConversion(unit, Function.createFunction(factor, constant)));
	}
	...
	@Override
	public void createConversion(final PersistentUnit unit, final common.Fraction factor,
			final common.Fraction constant, final Invoker invoker) throws PersistenceException {
		java.sql.Date now = new java.sql.Date(new java.util.Date().getTime());
		PersistentCreateConversionCommand command = model.meta.CreateConversionCommand.createCreateConversionCommand(
