...
public class CompUnitType extends model.quantity.AbsUnitType implements PersistentCompUnitType {
	...
	public static PersistentCompUnitType createCompUnitType(final String name, final boolean delayed$Persistence)
	...
	public static PersistentCompUnitType createCompUnitType(final String name, final boolean delayed$Persistence,
			final PersistentCompUnitType This) throws PersistenceException {
		PersistentCompUnitType result = null;
		if (delayed$Persistence) {
			result = ConnectionHandler.getTheConnectionHandler().theCompUnitTypeFacade.newDelayedCompUnitType(name);
			result.setDelayed$Persistence(true);
	...
	public CompUnitType provideCopy() throws PersistenceException {
		...
		result = new CompUnitType(this.name, this.This, this.getId());
	...
	public CompUnitType(final String name, final PersistentAbsUnitType This, final long id)
	...
	@Override
	public <E extends UserException> void accept(final AbsUnitTypeExceptionVisitor<E> visitor)
			throws PersistenceException, E {
		visitor.handleCompUnitType(this);
	}

	@Override
	public <R, E extends UserException> R accept(final AbsUnitTypeReturnExceptionVisitor<R, E> visitor)
			throws PersistenceException, E {
		return visitor.handleCompUnitType(this);
	}
