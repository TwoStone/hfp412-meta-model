...
public class FractionManager extends PersistentObject implements PersistentFractionManager{
    ...
    java.util.Hashtable<String,Object> result = null;
        if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth){
            ...
            result.put("managedFractions", this.getManagedFractions().getValues().getVector(allResults, depth, essentialLevel, forGUI, tdObserver, false, essentialLevel == 0));
    ...
    public int getLeafInfo() throws PersistenceException{
        if( this.getManagedFractions().getValues().getLength() > 0) return 1;
        return 0;
    }
