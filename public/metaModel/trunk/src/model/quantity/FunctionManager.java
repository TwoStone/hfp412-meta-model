...
public class FunctionManager extends PersistentObject implements PersistentFunctionManager{
    ...
    java.util.Hashtable<String,Object> result = null;
        if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth){
            ...
            result.put("functions", this.getFunctions().getVector(allResults, depth, essentialLevel, forGUI, tdObserver, false, essentialLevel == 0));
    ...
    public int getLeafInfo() throws PersistenceException{
        if (this.getFunctions().getLength() > 0) return 1;
        return 0;
    }
