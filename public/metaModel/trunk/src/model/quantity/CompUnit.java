...
public class CompUnit extends model.quantity.AbsUnit implements PersistentCompUnit {
	...
	public static PersistentCompUnit createCompUnit(PersistentAbsUnitType type, String name)
			throws PersistenceException {
		return createCompUnit(type, name, false);
	}

	public static PersistentCompUnit createCompUnit(PersistentAbsUnitType type, String name, boolean delayed$Persistence)
			throws PersistenceException {
	...
	public static PersistentCompUnit createCompUnit(PersistentAbsUnitType type, String name,
			boolean delayed$Persistence, PersistentCompUnit This) throws PersistenceException {
		PersistentCompUnit result = null;
		if (delayed$Persistence) {
			result = ConnectionHandler.getTheConnectionHandler().theCompUnitFacade.newDelayedCompUnit(name);
			result.setDelayed$Persistence(true);
	...
	public CompUnit provideCopy() throws PersistenceException {
		...
		result = new CompUnit(this.type, this.name, this.This, this.getId());
	...
	public CompUnit(PersistentAbsUnitType type, String name, PersistentAbsUnit This, long id)
			throws persistence.PersistenceException {
		/* Shall not be used by clients for object construction! Use static create operation instead! */
		super(type, name, This, id);
	...
	@Override
	public <R, E extends UserException> R accept(AbsUnitReturnExceptionVisitor<R, E> visitor)
	...
	public int getLeafInfo() throws PersistenceException {
		return (int) (0 + this.getRefs().getLength());
	}
	...
	@Override
	public void checkExponents() throws model.ExponentMatchingException, PersistenceException {
