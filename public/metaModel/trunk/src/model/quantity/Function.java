...
public class Function extends PersistentObject implements PersistentFunction {
	...
	public static PersistentFunction createFunction(common.Fraction factor, common.Fraction constant)
	...
	public static PersistentFunction createFunction(common.Fraction factor, common.Fraction constant,
			boolean delayed$Persistence, PersistentFunction This) throws PersistenceException {
		PersistentFunction result = null;
		if (delayed$Persistence) {
			result = ConnectionHandler.getTheConnectionHandler().theFunctionFacade.newDelayedFunction(factor, constant);
			result.setDelayed$Persistence(true);
	...
	public Function provideCopy() throws PersistenceException {
		...
		result = new Function(this.factor, this.constant, this.This, this.getId());
	...
	public Function(common.Fraction factor, common.Fraction constant, PersistentFunction This, long id)
