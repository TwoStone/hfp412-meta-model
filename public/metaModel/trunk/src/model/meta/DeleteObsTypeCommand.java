...
import model.visitor.ObsTypeManagerCommandExceptionVisitor;
import model.visitor.ObsTypeManagerCommandReturnExceptionVisitor;
import model.visitor.ObsTypeManagerCommandReturnVisitor;
import model.visitor.ObsTypeManagerCommandVisitor;
...
public class DeleteObsTypeCommand extends PersistentObject implements PersistentDeleteObsTypeCommand{
    ...
    public DeleteObsTypeCommand(PersistentMObservationType theType,Invoker invoker,PersistentObsTypeManager commandReceiver,PersistentCommonDate myCommonDate,long id) throws persistence.PersistenceException {
