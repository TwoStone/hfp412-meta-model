...
public class AddReferenceTypeCommand extends PersistentObject implements PersistentAddReferenceTypeCommand{
    ...
    public void store() throws PersistenceException {
        ...
        if(this.getCommandResult() != null){
            ...
            ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade.commandResultSet(this.getId(), getCommandResult());
        }
    ...
    public int getLeafInfo() throws PersistenceException{
        ...
        if (this.getReferenceUnitType() != null) return 1;
    ...
    public void execute() 
        ...
        try{
			this.setCommandResult(this.getCommandReceiver().addReferenceType(this.getName(), this.getUnitType(), this.getReferenceUnitType(), this.getExponent()));
		}
