...
public class AddReferenceTypeCommand extends PersistentObject implements PersistentAddReferenceTypeCommand {
	...
	public static PersistentAddReferenceTypeCommand createAddReferenceTypeCommand(String name, long exponent,
	...
	public AddReferenceTypeCommand(String name, PersistentAbsUnitType unitType, PersistentUnitType referenceUnitType,
			long exponent, Invoker invoker, PersistentUnitTypeManager commandReceiver,
			PersistentCompUnitType commandResult, PersistentCommonDate myCommonDate, long id)
	...
	public void store() throws PersistenceException {
		if (!this.isDelayed$Persistence())
			return;
		if (this.getClassId() == 195)
			ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade.newAddReferenceTypeCommand(
					name, exponent, this.getId());
		super.store();
		if (this.getUnitType() != null) {
			this.getUnitType().store();
			ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade.unitTypeSet(this.getId(),
					getUnitType());
		}
		if (this.getReferenceUnitType() != null) {
			this.getReferenceUnitType().store();
			ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade.referenceUnitTypeSet(
					this.getId(), getReferenceUnitType());
		}
		if (this.getInvoker() != null) {
			this.getInvoker().store();
			ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade.invokerSet(this.getId(),
					getInvoker());
		}
		if (this.getCommandReceiver() != null) {
			this.getCommandReceiver().store();
			ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade.commandReceiverSet(
					this.getId(), getCommandReceiver());
		}
		if (this.getCommandResult() != null) {
			this.getCommandResult().store();
			ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade.commandResultSet(this.getId(),
					getCommandResult());
		}
		if (this.getMyCommonDate() != null) {
			this.getMyCommonDate().store();
			ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade.myCommonDateSet(this.getId(),
					getMyCommonDate());
		}
	...
	public void setName(String newValue) throws PersistenceException {
		if (newValue == null)
			throw new PersistenceException("Null not allowed for persistent strings, since null = \"\" in Oracle!", 0);
		if (!this.isDelayed$Persistence())
			ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade
	...
	public void setUnitType(PersistentAbsUnitType newValue) throws PersistenceException {
		...
		if (newValue.equals(this.unitType))
			return;
	...
	public void setReferenceUnitType(PersistentUnitType newValue) throws PersistenceException {
		if (newValue == null)
			throw new PersistenceException("Null values not allowed!", 0);
		if (newValue.equals(this.referenceUnitType))
			return;
		long objectId = newValue.getId();
		long classId = newValue.getClassId();
	...
	public void setExponent(long newValue) throws PersistenceException {
		if (!this.isDelayed$Persistence())
			ConnectionHandler.getTheConnectionHandler().theAddReferenceTypeCommandFacade.exponentSet(this.getId(),
					newValue);
	...
	public int getLeafInfo() throws PersistenceException {
		return 0 + (this.getUnitType() == null ? 0 : 1) + (this.getReferenceUnitType() == null ? 0 : 1)
	...
	public void execute() throws PersistenceException {
		try {
			this.setCommandResult(this.getCommandReceiver().addReferenceType(this.getName(), this.getUnitType(),
					this.getReferenceUnitType(), this.getExponent()));
