...
public class AggregateCommand extends PersistentObject implements PersistentAggregateCommand{
    ...
    public AggregateCommand(AggregationStrategy strategy,Invoker invoker,PersistentQuantifObject commandReceiver,PersistentQuantity commandResult,PersistentCommonDate myCommonDate,long id) throws persistence.PersistenceException {
