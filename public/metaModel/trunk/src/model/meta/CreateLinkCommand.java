...
public class CreateLinkCommand extends PersistentObject implements PersistentCreateLinkCommand{
    ...
    public CreateLinkCommand(PersistentAssociation type,PersistentMObject source,PersistentMObject target,Invoker invoker,PersistentLinkManager commandReceiver,PersistentLink commandResult,PersistentCommonDate myCommonDate,long id) throws persistence.PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if(this.getCommandResult() != null){
            ...
            ConnectionHandler.getTheConnectionHandler().theCreateLinkCommandFacade.commandResultSet(this.getId(), getCommandResult());
        }
    ...
    public void setCommandResult(PersistentLink newValue) throws PersistenceException {
        if (newValue == null) throw new PersistenceException("Null values not allowed!", 0);
        ...
        if(!this.isDelayed$Persistence()){
            newValue.store();
            ConnectionHandler.getTheConnectionHandler().theCreateLinkCommandFacade.commandResultSet(this.getId(), newValue);
        }
    }
    ...
    public void execute() 
        ...
        try{
			this.setCommandResult(this.getCommandReceiver().createLink(this.getType(), this.getSource(), this.getTarget()));
		}
