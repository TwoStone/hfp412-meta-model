...
public class Message extends model.MessageOrLink implements PersistentMessage{
    
    
    public static PersistentMessage createMessage(PersistentInstanceObject source,PersistentInstanceObject target,PersistentMOperation type) throws PersistenceException{
        return createMessage(source,target,type,false);
    }
    
    public static PersistentMessage createMessage(PersistentInstanceObject source,PersistentInstanceObject target,PersistentMOperation type,boolean delayed$Persistence) throws PersistenceException {
    ...
    public static PersistentMessage createMessage(PersistentInstanceObject source,PersistentInstanceObject target,PersistentMOperation type,boolean delayed$Persistence,PersistentMessage This) throws PersistenceException {
        PersistentMessage result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theMessageFacade
                .newDelayedMessage();
    ...
    protected PersistentMOperation type;
    
    public Message(PersistentInstanceObject source,PersistentInstanceObject target,PersistentMessageOrLink This,PersistentMOperation type,long id) throws persistence.PersistenceException {
    ...
    public void setType(PersistentMOperation newValue) throws PersistenceException {
        ...
        this.type = (PersistentMOperation)PersistentProxi.createProxi(objectId, classId);
    ...
    public void initialize(final Anything This, final java.util.Hashtable<String,Object> final$$Fields) 
		...
		if(this.equals(This)){
			...
			this.setType((PersistentMOperation)final$$Fields.get("type"));
		}
    }
