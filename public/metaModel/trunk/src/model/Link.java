...
public class Link extends model.MessageOrLink implements PersistentLink{
    
    
    public static PersistentLink createLink(PersistentInstanceObject source,PersistentInstanceObject target,PersistentMAssociation type) throws PersistenceException{
        return createLink(source,target,type,false);
    }
    
    public static PersistentLink createLink(PersistentInstanceObject source,PersistentInstanceObject target,PersistentMAssociation type,boolean delayed$Persistence) throws PersistenceException {
    ...
    public static PersistentLink createLink(PersistentInstanceObject source,PersistentInstanceObject target,PersistentMAssociation type,boolean delayed$Persistence,PersistentLink This) throws PersistenceException {
        PersistentLink result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theLinkFacade
                .newDelayedLink();
    ...
    protected PersistentMAssociation type;
    
    public Link(PersistentInstanceObject source,PersistentInstanceObject target,PersistentMessageOrLink This,PersistentMAssociation type,long id) throws persistence.PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 207) ConnectionHandler.getTheConnectionHandler().theLinkFacade
            .newLink(this.getId());
        super.store();
    ...
    public void setType(PersistentMAssociation newValue) throws PersistenceException {
        ...
        this.type = (PersistentMAssociation)PersistentProxi.createProxi(objectId, classId);
    ...
    public void initialize(final Anything This, final java.util.Hashtable<String,Object> final$$Fields) 
		...
		if(this.equals(This)){
			...
			this.setType((PersistentMAssociation)final$$Fields.get("type"));
		}
    }
