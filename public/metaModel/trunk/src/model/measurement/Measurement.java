...
public class Measurement extends model.measurement.QuantifObject implements PersistentMeasurement {
	...
	@Override
	public AccountSearchList inverseGetEntries() throws PersistenceException {
		AccountSearchList result = null;
		if (result == null)
			result = ConnectionHandler.getTheConnectionHandler().theAccountFacade.inverseGetEntries(this.getId(), this.getClassId());
		return result;
	}
