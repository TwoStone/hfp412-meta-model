...
public class ActualParameter extends PersistentObject implements PersistentActualParameter{
    ...
    public static PersistentActualParameter createActualParameter(PersistentMFormalParameter type,PersistentInstanceObject value) throws PersistenceException{
        return createActualParameter(type,value,false);
    }
    
    public static PersistentActualParameter createActualParameter(PersistentMFormalParameter type,PersistentInstanceObject value,boolean delayed$Persistence) throws PersistenceException {
    ...
    public static PersistentActualParameter createActualParameter(PersistentMFormalParameter type,PersistentInstanceObject value,boolean delayed$Persistence,PersistentActualParameter This) throws PersistenceException {
        PersistentActualParameter result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theActualParameterFacade
                .newDelayedActualParameter();
    ...
    protected PersistentMFormalParameter type;
    protected PersistentInstanceObject value;
    protected PersistentActualParameter This;
    
    public ActualParameter(PersistentMFormalParameter type,PersistentInstanceObject value,PersistentActualParameter This,long id) throws persistence.PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 199) ConnectionHandler.getTheConnectionHandler().theActualParameterFacade
    ...
    public void setType(PersistentMFormalParameter newValue) throws PersistenceException {
        ...
        this.type = (PersistentMFormalParameter)PersistentProxi.createProxi(objectId, classId);
    ...
    public void initialize(final Anything This, final java.util.Hashtable<String,Object> final$$Fields) 
		...
		if(this.equals(This)){
			this.setType((PersistentMFormalParameter)final$$Fields.get("type"));
