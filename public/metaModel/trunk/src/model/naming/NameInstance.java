...
public class NameInstance extends PersistentObject implements PersistentNameInstance{
    ...
    java.util.Hashtable<String,Object> result = null;
        if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth){
            ...
            if (fromObject != null) {
                result.put("fromObject", fromObject.createProxiInformation(false));
                if(depth > 1) {
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 246) ConnectionHandler.getTheConnectionHandler().theNameInstanceFacade
