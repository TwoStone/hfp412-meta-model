...
public class ExponentMatchingException extends model.UserException{
    ...
    public ExponentMatchingException(String message) throws persistence.PersistenceException {
        super(message);        
    }
