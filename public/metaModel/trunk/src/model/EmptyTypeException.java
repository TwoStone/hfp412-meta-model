...
public class EmptyTypeException extends model.UserException{
    ...
    public EmptyTypeException(String message) throws persistence.PersistenceException {
        super(message);        
    }
