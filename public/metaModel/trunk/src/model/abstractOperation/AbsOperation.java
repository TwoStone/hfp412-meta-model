...
public abstract class AbsOperation extends PersistentObject implements PersistentAbsOperation {
	...
	public java.util.Hashtable<String, Object> toHashtable(final java.util.Hashtable<String, Object> allResults,
		...
		if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth) {
			...
			result.put(
					"parameters",
					this.getParameters().getVector(allResults, depth, essentialLevel, forGUI, tdObserver, false,
							essentialLevel == 0));
	...
	public AbsOperation(final String name, final PersistentMType source, final PersistentMType target,
