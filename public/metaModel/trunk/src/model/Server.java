...
public class Server extends PersistentObject implements PersistentServer{
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == -123) ConnectionHandler.getTheConnectionHandler().theServerFacade
    ...
    public void createEnumValue(final PersistentMEnum type, final String name) 
				throws PersistenceException{
		EnumerationManager.getTheEnumerationManager().createEnumValue(name, type, getThis());
    ...
    public void deleteEnumValue(final PersistentMEnumValue enumValue) 
				throws PersistenceException{
		EnumerationManager.getTheEnumerationManager().deleteEnumValue(enumValue, getThis());
