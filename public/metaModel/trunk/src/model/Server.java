...
public class Server extends PersistentObject implements PersistentServer {
	...
	public int getLeafInfo() throws PersistenceException {
		return 0 + (this.getAspectManager() == null ? 0 : 1) + (this.getTypeManager() == null ? 0 : 1)
				...
				+ (this.getAccountManager() == null ? 0 : 1) + (this.getAssociationManager() == null ? 0 : 1)
				+ (this.getOperationManager() == null ? 0 : 1) + (this.getMessageManager() == null ? 0 : 1)
	...
	@Override
	public void createAtomicRootType(final PersistentMAspect aspect, final String typeName,
			final PersistentMBoolean singletonType, final PersistentMBoolean abstractType) throws PersistenceException {
	...
	@Override
	public void createQuantity(final PersistentAbsUnit unit, final common.Fraction f) throws PersistenceException {
	...
	@Override
	public void createCompUnitType(final String name) throws PersistenceException {
