...
public class Server extends PersistentObject implements PersistentServer {
	...
	@Override
	public void createEnum(final String name) throws PersistenceException {
	...
	@Override
	public void createObservation(final PersistentMObservationType theType, final String name,
			final PersistentMObject theObsObject, final PersistentMEnumValue enumValue) throws PersistenceException {
		ObservationManager.getTheObservationManager().createObservation(name, theType, theObsObject, enumValue,
				getThis());
	}
