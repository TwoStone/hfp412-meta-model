...
public class Server extends PersistentObject implements PersistentServer{
	...
	private void demoUnits() throws DoubleDefinitionException, PersistenceException {
		...
		final PersistentQuantity q_3_m = QuantityManager.getTheQuantityManager().createQuantity(meter,
				Fraction.parse("3"));
		final PersistentQuantity q_2_m = QuantityManager.getTheQuantityManager().createQuantity(meter,
				Fraction.parse("2"));
