...
public class MEmptyTypeConjunction extends model.typeSystem.MAtomicTypeConjunction implements
	...
	public MEmptyTypeConjunction(PersistentMType This, PersistentMModelItem myCONCMModelItem, long id)
	...
	public int getLeafInfo() throws PersistenceException {
		return (int) (0 + this.getDependentItems().getLength() + this.getContainedTypes().getLength());
	}
