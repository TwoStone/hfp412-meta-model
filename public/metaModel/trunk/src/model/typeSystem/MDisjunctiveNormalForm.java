...
public abstract class MDisjunctiveNormalForm extends model.typeSystem.MAbstractTypeDisjunction implements
		PersistentMDisjunctiveNormalForm {
	...
	public MDisjunctiveNormalForm(PersistentMType This, PersistentMModelItem myCONCMModelItem, long id)
	...
	public void initialize(final Anything This, final java.util.Hashtable<String, Object> final$$Fields)
		...
		if (this.equals(This)) {
			PersistentCONCMModelItem myCONCMModelItem = model.CONCMModelItem.createCONCMModelItem(
					this.isDelayed$Persistence(), (PersistentMDisjunctiveNormalForm) This);
