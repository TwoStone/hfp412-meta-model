...
public class MSingletonObject extends model.typeSystem.AbstractObject implements PersistentMSingletonObject {
	...
	public static PersistentMSingletonObject createMSingletonObject(final PersistentMAtomicType type) throws PersistenceException {
		return createMSingletonObject(type, false);
	}

	public static PersistentMSingletonObject createMSingletonObject(final PersistentMAtomicType type, final boolean delayed$Persistence)
	...
	public static PersistentMSingletonObject createMSingletonObject(final PersistentMAtomicType type, final boolean delayed$Persistence,
			final PersistentMSingletonObject This) throws PersistenceException {
		PersistentMSingletonObject result = null;
		if (delayed$Persistence) {
			result = ConnectionHandler.getTheConnectionHandler().theMSingletonObjectFacade.newDelayedMSingletonObject();
			result.setDelayed$Persistence(true);
	...
	public MSingletonObject(final PersistentAbstractObject This, final PersistentMModelItem myCONCMModelItem, final PersistentMAtomicType type,
	...
	public void initialize(final Anything This, final java.util.Hashtable<String, Object> final$$Fields) throws PersistenceException {
		...
		if (this.equals(This)) {
			final PersistentCONCMModelItem myCONCMModelItem = model.CONCMModelItem.createCONCMModelItem(this.isDelayed$Persistence(),
					(PersistentMSingletonObject) This);
	...
	public PersistentMNonEmptyAtomicTypeConjunction fetchProductType() throws PersistenceException {
		...
		System.out.println(transientCreateNETypeConj.isDelayed$Persistence());
