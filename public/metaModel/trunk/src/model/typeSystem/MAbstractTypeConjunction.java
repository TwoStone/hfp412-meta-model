...
public abstract class MAbstractTypeConjunction extends model.typeSystem.MComplexType implements PersistentMAbstractTypeConjunction {
	...
	public MAbstractTypeConjunction(final PersistentMType This, final PersistentMModelItem myCONCMModelItem, final long id)
	...
	public void initialize(final Anything This, final java.util.Hashtable<String, Object> final$$Fields) throws PersistenceException {
		...
		if (this.equals(This)) {
			final PersistentCONCMModelItem myCONCMModelItem = model.CONCMModelItem.createCONCMModelItem(this.isDelayed$Persistence(),
					(PersistentMAbstractTypeConjunction) This);
