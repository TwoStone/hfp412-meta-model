...
public abstract class AbstractObject extends PersistentObject implements PersistentAbstractObject {
	...
	public java.util.Hashtable<String, Object> toHashtable(final java.util.Hashtable<String, Object> allResults,
		...
		if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth) {
			...
			final AbstractPersistentRoot productType = this.getProductType(tdObserver);
			if (productType != null) {
	...
	public AbstractObject(final PersistentAbstractObject This, final PersistentMModelItem myCONCMModelItem,
	...
	public void store() throws PersistenceException {
		...
		if (this.getMyCONCMModelItem() != null) {
			...
			ConnectionHandler.getTheConnectionHandler().theAbstractObjectFacade.myCONCMModelItemSet(this.getId(),
					getMyCONCMModelItem());
		}
	...
	public void initialize(final Anything This, final java.util.Hashtable<String, Object> final$$Fields)
		...
		if (this.equals(This)) {
			final PersistentCONCMModelItem myCONCMModelItem = model.CONCMModelItem.createCONCMModelItem(
					this.isDelayed$Persistence(), (PersistentAbstractObject) This);
	...
	public PersistentMNonEmptyAtomicTypeConjunction getProductType(final TDObserver observer)
			throws PersistenceException {
		final PersistentMNonEmptyAtomicTypeConjunction result = getThis().getProductType();
