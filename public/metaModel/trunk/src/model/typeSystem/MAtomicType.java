...
public class MAtomicType extends model.typeSystem.MType implements PersistentMAtomicType {
	...
	public MAtomicType(PersistentMType This, PersistentMModelItem myCONCMModelItem, String name,
			PersistentMBoolean singletonType, PersistentMBoolean abstractType, PersistentMAspect aspect,
			PersistentMAtomicType superType, long id) throws persistence.PersistenceException {
	...
	public int getLeafInfo() throws PersistenceException {
		return (int) (0 + this.getDependentItems().getLength() + (this.getSingletonType() == null ? 0 : 1)
				+ (this.getAbstractType() == null ? 0 : 1) + this.getSubTypes().getLength() + this.getPossibleNames()
				.getLength());
	}
