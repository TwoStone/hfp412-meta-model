...
public class MAtomicType extends model.typeSystem.MType implements PersistentMAtomicType{
    ...
    public PersistentMBoolean isStructuralEquivalant(final PersistentMType other) 
    	...
    	return other.accept(new MTypeReturnVisitor<PersistentMBoolean>() {
			...
			@Override
			public PersistentMBoolean handleMAbstractProductType(
			...
			@Override
			public PersistentMBoolean handleMEmptySumType(
					PersistentMEmptySumType mEmptySumType)
					throws PersistenceException {
				return MFalse.getTheMFalse();
			}

			@Override
			public PersistentMBoolean handleMSumType(PersistentMSumType mSumType)
					throws PersistenceException {
				return MFalse.getTheMFalse();
			}

			@Override
			public PersistentMBoolean handleMProductType(
					PersistentMProductType mProductType)
					throws PersistenceException {
				return  MFalse.getTheMFalse();
			}

			@Override
			public PersistentMBoolean handleMEmptyProduct(
					PersistentMEmptyProduct mEmptyProduct)
					throws PersistenceException {
				return  MFalse.getTheMFalse();
			}

			@Override
			public PersistentMBoolean handleMAtomicType(
					PersistentMAtomicType mAtomicType)
					throws PersistenceException {
				return MBoolean.createFromBoolean(
						getThis().getAspect().equals(mAtomicType.getAspect()) &&
