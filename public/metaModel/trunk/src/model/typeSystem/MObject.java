...
public class MObject extends model.typeSystem.AbstractObject implements PersistentMObject{
    ...
    java.util.Hashtable<String,Object> result = null;
        if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth){
            ...
            result.put("linksFromMe", this.getLinksFromMe(tdObserver).getVector(allResults, (depth > 1 ? depth : depth + 1), essentialLevel, forGUI, tdObserver, false));
            result.put("linksToMe", this.getLinksToMe(tdObserver).getVector(allResults, (depth > 1 ? depth : depth + 1), essentialLevel, forGUI, tdObserver, false));
    ...
    public int getLeafInfo() throws PersistenceException{
        return (int) (0 
            ...
            + this.getLinksFromMe().getLength()
            + this.getLinksToMe().getLength()
