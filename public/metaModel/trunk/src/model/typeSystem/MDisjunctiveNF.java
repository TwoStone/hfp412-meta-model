...
public class MDisjunctiveNF extends model.typeSystem.MNonEmptySumType implements PersistentMDisjunctiveNF{
    ...
    public static PersistentMDisjunctiveNF createMDisjunctiveNF(boolean delayed$Persistence) throws PersistenceException {
        PersistentMDisjunctiveNF result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theMDisjunctiveNFFacade
                .newDelayedMDisjunctiveNF();
    ...
    public static PersistentMDisjunctiveNF createMDisjunctiveNF(boolean delayed$Persistence,PersistentMDisjunctiveNF This) throws PersistenceException {
        PersistentMDisjunctiveNF result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theMDisjunctiveNFFacade
                .newDelayedMDisjunctiveNF();
    ...
    public MDisjunctiveNF provideCopy() throws PersistenceException{
        ...
        result = new MDisjunctiveNF(this.This, 
                                    this.getId());
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 278) ConnectionHandler.getTheConnectionHandler().theMDisjunctiveNFFacade
            .newMDisjunctiveNF(this.getId());
        super.store();
    ...
    public PersistentMDisjunctiveNF transientMultiply(final PersistentMDisjunctiveNF other) 
				throws PersistenceException{
