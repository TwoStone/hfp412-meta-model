...
public class Link extends model.messageOrLink.MessageOrLink implements PersistentLink {
	...
	public static PersistentLink createLink(PersistentMObject source, PersistentMObject target,
			PersistentAssociation type) throws PersistenceException {
		return createLink(source, target, type, false);
	}

	public static PersistentLink createLink(PersistentMObject source, PersistentMObject target,
			PersistentAssociation type, boolean delayed$Persistence) throws PersistenceException {
	...
	public static PersistentLink createLink(PersistentMObject source, PersistentMObject target,
			PersistentAssociation type, boolean delayed$Persistence, PersistentLink This) throws PersistenceException {
		PersistentLink result = null;
		if (delayed$Persistence) {
			result = ConnectionHandler.getTheConnectionHandler().theLinkFacade.newDelayedLink();
			result.setDelayed$Persistence(true);
	...
	public Link provideCopy() throws PersistenceException {
		Link result = this;
		result = new Link(this.source, this.target, this.This, this.type, this.getId());
	...
	public Link(PersistentMObject source, PersistentMObject target, PersistentMessageOrLink This,
			PersistentAssociation type, long id) throws persistence.PersistenceException {
		/* Shall not be used by clients for object construction! Use static create operation instead! */
		super(source, target, This, id);
		this.type = type;
	}
	...
	@Override
	public <E extends UserException> void accept(MessageOrLinkExceptionVisitor<E> visitor) throws PersistenceException,
			E {
		visitor.handleLink(this);
	}

	@Override
	public <R, E extends UserException> R accept(MessageOrLinkReturnExceptionVisitor<R, E> visitor)
