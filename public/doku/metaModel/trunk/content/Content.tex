...
% Sperrvermerk
\newpage
\setPageTitle{Sperrvermerk} % Seitentitel ändern, da diese Section ausgeblendet ist
\include{\content/pages/Sperrvermerk} % Inhalt einbinden
...
% Kapitel
\include{\content/sections/Inter} % Inhalt einbinden

% Kapitel
\include{\content/sections/Pedes} % Inhalt einbinden

% Kapitel
\include{\content/sections/Virginem} % Inhalt einbinden

% Kapitel
\include{\content/sections/Gaudium_Est} % Inhalt einbinden

% Kapitel
\include{\content/sections/Iuvenum} % Inhalt einbinden
...
\newpage
\setPageTitle{Ehrenwörtliche Erklärung} % Seitentitel ändern, da diese Section ausgeblendet ist
\include{\content/pages/Ehrenwoertliche_Erklaerung} % Inhalt einbinden
