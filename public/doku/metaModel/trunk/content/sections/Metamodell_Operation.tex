...
Die Klasse \term{Operation} enthält nur genau zwei Operationen.
...
Der \term{AssociationManager} bietet sechs transaktionale Operationen an und beinhaltet zwei Listen, welche er verwaltet.
\begin{description}
