...
Es bietet sich beispielsweise an, eine Klasse \term{Multiplicity} zwischen \term{AbstractOperation} und \term{Type} zu hängen,
...
Bevor Messages umgesetzt werden können, muss sich geeinigt werden, welche der genannten Interpretationen für ein Message-Exemplars zutrifft. 
  ...
  \item[Path] \TODO[Noch schreiben\ldots]
  \item[Posting Rules] \TODO[Noch schreiben\ldots]
  \item[Versionierung] \TODO[Noch schreiben\ldots]
  \item[Zentrale Ablage der Constraints] \TODO[Noch schreiben\ldots]
\end{description}
