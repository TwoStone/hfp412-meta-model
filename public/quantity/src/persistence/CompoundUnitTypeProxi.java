...
public class CompoundUnitTypeProxi extends AbsUnitTypeProxi implements PersistentCompoundUnitType{
    
    public CompoundUnitTypeProxi(long objectId) {
        super(objectId);
    }
    public CompoundUnitTypeProxi(PersistentInCacheProxi object) {
        super(object);
    }
