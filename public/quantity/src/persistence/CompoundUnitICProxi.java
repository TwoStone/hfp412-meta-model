...
public class CompoundUnitICProxi extends AbsUnitICProxi implements PersistentCompoundUnit{
    
    public CompoundUnitICProxi(long objectId) {
        super(objectId);
    }
    public CompoundUnitICProxi(PersistentObject object) {
        super(object);
    }
