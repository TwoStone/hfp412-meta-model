...
public class ConversionRateICProxi extends PersistentInCacheProxiOptimistic implements PersistentConversionRate{
    
    public ConversionRateICProxi(long objectId) {
        super(objectId);
    }
    public ConversionRateICProxi(PersistentObject object) {
        super(object);
    }
