...
public class TypeReferenceProxi extends AbsUnitTypeProxi implements PersistentTypeReference{
    
    public TypeReferenceProxi(long objectId) {
        super(objectId);
    }
    public TypeReferenceProxi(PersistentInCacheProxi object) {
        super(object);
    }
