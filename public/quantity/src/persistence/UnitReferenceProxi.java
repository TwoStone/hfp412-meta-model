...
public class UnitReferenceProxi extends AbsUnitProxi implements PersistentUnitReference{
    
    public UnitReferenceProxi(long objectId) {
        super(objectId);
    }
    public UnitReferenceProxi(PersistentInCacheProxi object) {
        super(object);
    }
