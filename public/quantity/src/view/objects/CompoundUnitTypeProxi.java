...
public class CompoundUnitTypeProxi extends AbsUnitTypeProxi implements CompoundUnitTypeView{
    
    public CompoundUnitTypeProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public CompoundUnitTypeView getRemoteObject(java.util.Hashtable<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        CompoundUnitTypeView result$$ = new CompoundUnitType( this.getId(), this.getClassId());
    ...
    public void setIcon(IconRenderer renderer){
        renderer.setIcon(null);
            //TODO: implement setIcon in view class CompoundUnitType
    }
