...
public class UnitReferenceProxi extends AbsUnitProxi implements UnitReferenceView{
    
    public UnitReferenceProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public UnitReferenceView getRemoteObject(java.util.Hashtable<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        String name = (String)resultTable.get("name");
        UnitReferenceView result$$ = new UnitReference((String)name, this.getId(), this.getClassId());
