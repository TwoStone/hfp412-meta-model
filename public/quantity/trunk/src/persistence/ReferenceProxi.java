...
public class ReferenceProxi extends PersistentProxi implements PersistentReference{
    
    public ReferenceProxi(long objectId) {
        super(objectId);
    }
    public ReferenceProxi(PersistentInCacheProxi object) {
        super(object);
    }
