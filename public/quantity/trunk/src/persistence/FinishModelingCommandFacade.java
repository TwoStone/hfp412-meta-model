...
public class FinishModelingCommandFacade{
    ...
    public FinishModelingCommandProxi newFinishModelingCommand(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (FinishModelingCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 147);
        ...
        return (FinishModelingCommandProxi)PersistentProxi.createProxi(id, 147);
    }
