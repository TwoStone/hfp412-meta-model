...
public class ComposedQuantityICProxi extends AbsQuantityICProxi implements PersistentComposedQuantity{
    
    public ComposedQuantityICProxi(long objectId) {
        super(objectId);
    }
    public ComposedQuantityICProxi(PersistentObject object) {
        super(object);
    }
