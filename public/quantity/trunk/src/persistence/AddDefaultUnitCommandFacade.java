...
public class AddDefaultUnitCommandFacade{
    ...
    public AddDefaultUnitCommandProxi newAddDefaultUnitCommand(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (AddDefaultUnitCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 125);
        ...
        return (AddDefaultUnitCommandProxi)PersistentProxi.createProxi(id, 125);
    }
