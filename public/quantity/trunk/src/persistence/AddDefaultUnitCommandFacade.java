...
public class AddDefaultUnitCommandFacade{
    ...
    public AddDefaultUnitCommandProxi newAddDefaultUnitCommand(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (AddDefaultUnitCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 136);
        ...
        return (AddDefaultUnitCommandProxi)PersistentProxi.createProxi(id, 136);
    }
    ...
    public void commandReceiverSet(long AddDefaultUnitCommandId, PersistentTypeManager commandReceiverVal) throws PersistenceException {
