...
public class CompoundQuantityFacade{
    ...
    public CompoundQuantityProxi newCompoundQuantity(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CompoundQuantityProxi)PersistentProxi.createProxi(createMinusStorePlus, 123);
        ...
        return (CompoundQuantityProxi)PersistentProxi.createProxi(id, 123);
    }
