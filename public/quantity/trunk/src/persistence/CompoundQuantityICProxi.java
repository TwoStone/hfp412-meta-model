...
public class CompoundQuantityICProxi extends AbsQuantityICProxi implements PersistentCompoundQuantity{
    
    public CompoundQuantityICProxi(long objectId) {
        super(objectId);
    }
    public CompoundQuantityICProxi(PersistentObject object) {
        super(object);
    }
