...
public class BooleanTrueProxi extends BooleanValueProxi implements PersistentBooleanTrue{
    
    public BooleanTrueProxi(long objectId) {
        super(objectId);
    }
    public BooleanTrueProxi(PersistentInCacheProxi object) {
        super(object);
    }
