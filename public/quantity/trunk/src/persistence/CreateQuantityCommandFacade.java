...
public class CreateQuantityCommandFacade{
    ...
    public CreateQuantityCommandProxi newCreateQuantityCommand(common.Fraction amount,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateQuantityCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 119);
        ...
        return (CreateQuantityCommandProxi)PersistentProxi.createProxi(id, 119);
    }
