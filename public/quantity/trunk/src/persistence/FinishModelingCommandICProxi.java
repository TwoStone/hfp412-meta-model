...
public class FinishModelingCommandICProxi extends PersistentInCacheProxi implements PersistentFinishModelingCommand{
    
    public FinishModelingCommandICProxi(long objectId) {
        super(objectId);
    }
    public FinishModelingCommandICProxi(PersistentObject object) {
        super(object);
    }
