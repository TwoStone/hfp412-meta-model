...
public class FractionProxi extends PersistentProxi implements PersistentFraction{
    
    public FractionProxi(long objectId) {
        super(objectId);
    }
    public FractionProxi(PersistentInCacheProxi object) {
        super(object);
    }
