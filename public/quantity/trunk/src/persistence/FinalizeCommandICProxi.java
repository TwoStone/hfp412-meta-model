...
public class FinalizeCommandICProxi extends PersistentInCacheProxi implements PersistentFinalizeCommand{
    
    public FinalizeCommandICProxi(long objectId) {
        super(objectId);
    }
    public FinalizeCommandICProxi(PersistentObject object) {
        super(object);
    }
