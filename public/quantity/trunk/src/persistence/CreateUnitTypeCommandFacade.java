...
public class CreateUnitTypeCommandFacade{
    ...
    public CreateUnitTypeCommandProxi newCreateUnitTypeCommand(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (CreateUnitTypeCommandProxi)PersistentProxi.createProxi(createMinusStorePlus, 107);
        ...
        return (CreateUnitTypeCommandProxi)PersistentProxi.createProxi(id, 107);
    }
