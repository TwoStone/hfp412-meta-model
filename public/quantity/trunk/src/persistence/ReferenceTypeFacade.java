...
public class ReferenceTypeFacade{
    ...
    public ReferenceTypeProxi newReferenceType(long exponent,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (ReferenceTypeProxi)PersistentProxi.createProxi(createMinusStorePlus, 103);
        ...
        return (ReferenceTypeProxi)PersistentProxi.createProxi(id, 103);
    }
