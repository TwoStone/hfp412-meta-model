...
public class AddReferenceTypeCommandICProxi extends PersistentInCacheProxi implements PersistentAddReferenceTypeCommand{
    
    public AddReferenceTypeCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddReferenceTypeCommandICProxi(PersistentObject object) {
        super(object);
    }
