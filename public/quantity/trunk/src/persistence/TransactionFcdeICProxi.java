...
public class TransactionFcdeICProxi extends PersistentInCacheProxiOptimistic implements PersistentTransactionFcde{
    
    public TransactionFcdeICProxi(long objectId) {
        super(objectId);
    }
    public TransactionFcdeICProxi(PersistentObject object) {
        super(object);
    }
