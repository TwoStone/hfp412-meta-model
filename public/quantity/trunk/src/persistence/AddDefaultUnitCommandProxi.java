...
public class AddDefaultUnitCommandProxi extends PersistentProxi implements PersistentAddDefaultUnitCommand{
    
    public AddDefaultUnitCommandProxi(long objectId) {
        super(objectId);
    }
    public AddDefaultUnitCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
