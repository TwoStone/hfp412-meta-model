...
public class UnitTypeFacade{
    ...
    public UnitTypeProxi newUnitType(String name,long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (UnitTypeProxi)PersistentProxi.createProxi(createMinusStorePlus, 109);
        ...
        return (UnitTypeProxi)PersistentProxi.createProxi(id, 109);
    }
