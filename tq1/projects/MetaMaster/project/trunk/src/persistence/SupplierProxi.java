...
public class SupplierProxi extends RoleProxi implements PersistentSupplier{
    
    public SupplierProxi(long objectId) {
        super(objectId);
    }
    public SupplierProxi(PersistentInCacheProxi object) {
        super(object);
    }
