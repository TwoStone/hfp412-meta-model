...
public class Supplier extends model.Role implements PersistentSupplier{
    ...
    public static PersistentSupplier createSupplier(PersistentActor roleFor) throws PersistenceException {
    ...
    public static PersistentSupplier createSupplier(PersistentActor roleFor,PersistentSupplier This) throws PersistenceException {
        PersistentSupplier result = ConnectionHandler.getTheConnectionHandler().theSupplierFacade
            .newSupplier();
        java.util.Hashtable<String,Object> final$$Fields = new java.util.Hashtable<String,Object>();
        final$$Fields.put("roleFor", roleFor);
    ...
    public Supplier provideCopy() throws PersistenceException{
        ...
        result = new Supplier(this.roleFor, 
                              this.This, 
                              this.getId());
    ...
    public Supplier(PersistentActor roleFor,PersistentRole This,long id) throws persistence.PersistenceException {
