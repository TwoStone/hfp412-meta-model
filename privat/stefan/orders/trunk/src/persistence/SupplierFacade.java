...
public class SupplierFacade{
    ...
    public SupplierProxi newSupplier() throws PersistenceException {
        ...
        try{
            ...
            return (SupplierProxi)PersistentProxi.createProxi(id, 104);
    ...
    public Supplier getSupplier(long SupplierId) throws PersistenceException{
        try{
            ...
            PersistentActor roleFor = null;
            if (obj.getLong(2) != 0)
                roleFor = (PersistentActor)PersistentProxi.createProxi(obj.getLong(2), obj.getLong(3));
            PersistentRole This = null;
            if (obj.getLong(4) != 0)
                This = (PersistentRole)PersistentProxi.createProxi(obj.getLong(4), obj.getLong(5));
            Supplier result = new Supplier(roleFor,
                                           This,
                                           SupplierId);
            obj.close();
            callable.close();
