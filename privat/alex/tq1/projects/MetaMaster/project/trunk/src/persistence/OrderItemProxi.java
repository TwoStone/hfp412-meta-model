...
public class OrderItemProxi extends PersistentProxi implements PersistentOrderItem{
    
    public OrderItemProxi(long objectId) {
        super(objectId);
    }
    public OrderItemProxi(PersistentInCacheProxi object) {
        super(object);
    }
