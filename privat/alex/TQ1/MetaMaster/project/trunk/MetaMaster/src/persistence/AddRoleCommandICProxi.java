...
public class AddRoleCommandICProxi extends PersistentInCacheProxi implements PersistentAddRoleCommand{
    
    public AddRoleCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddRoleCommandICProxi(PersistentObject object) {
        super(object);
    }
