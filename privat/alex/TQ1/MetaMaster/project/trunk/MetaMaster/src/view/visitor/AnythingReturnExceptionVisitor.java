...
public interface AnythingReturnExceptionVisitor<R, E extends model.UserException> extends ActorReturnExceptionVisitor<R, E> ,RoleReturnExceptionVisitor<R, E> {
