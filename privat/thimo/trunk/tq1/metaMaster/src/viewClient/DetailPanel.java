...
class DetailPanelFactory implements view.visitor.AnythingVisitor {
    ...
    public void handleActorManager(view.ActorManagerView object){
        result = new ActorManagerDefaultDetailPanel(handler, object);
    }
    public void handleJuristicPerson(view.JuristicPersonView object){
        result = new JuristicPersonDefaultDetailPanel(handler, object);
    }
    ...
    public void handleActor(view.ActorView object){
        result = new ActorDefaultDetailPanel(handler, object);
    }
...
@SuppressWarnings("serial")
class ActorManagerDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String ActorManager$$actors = "ActorManager$$actors";
    
    protected ActorManagerDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        
    }
    protected view.ActorManagerView getAnything(){
        return (view.ActorManagerView)this.anything;
    }
}

@SuppressWarnings("serial")
class JuristicPersonDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String Actor$$name = "Actor$$name";
    protected static final String Actor$$myRoles = "Actor$$myRoles";
    
    protected JuristicPersonDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        try{
            ...
            this.panels.put(Actor$$name, panel);
        }catch(view.ModelException e){
            this.getExceptionAndEventhandler().handleException(e);
        }
        
    }
    protected view.JuristicPersonView getAnything(){
        return (view.JuristicPersonView)this.anything;
    }
}
...
class ProductDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String Product$$name = "Product$$name";
    ...
    protected void addFields(){
        try{
            BaseTypePanel panel = new StringPanel(this, "name", this.getAnything().getName());
            this.getScrollablePane().add(panel);
            this.panels.put(Product$$name, panel);
        }catch(view.ModelException e){
            this.getExceptionAndEventhandler().handleException(e);
        }
...
class ServerDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String Server$$actorManager = "Server$$actorManager";
...
@SuppressWarnings("serial")
class NaturalPersonDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String Actor$$name = "Actor$$name";
    protected static final String Actor$$myRoles = "Actor$$myRoles";
    
    protected NaturalPersonDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        try{
    ...
    protected view.NaturalPersonView getAnything(){
        return (view.NaturalPersonView)this.anything;
    }
}
...
class SupplierDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected SupplierDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
...
@SuppressWarnings("serial")
class ActorDefaultDetailPanel extends DefaultDetailPanel{
    
    protected static final String Actor$$name = "Actor$$name";
    protected static final String Actor$$myRoles = "Actor$$myRoles";
    
    protected ActorDefaultDetailPanel(ExceptionAndEventHandler exceptionHandler, Anything anything) {
        super(exceptionHandler, anything);
    }
    protected void addFields(){
        try{
    ...
    protected view.ActorView getAnything(){
        return (view.ActorView)this.anything;
    }
}
