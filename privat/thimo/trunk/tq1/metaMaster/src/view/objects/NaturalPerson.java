...
public class NaturalPerson extends view.objects.Actor implements NaturalPersonView{
    
    
    public NaturalPerson(String name,java.util.Vector<RoleView> myRoles,long id, long classId) {
        /* Shall not be used. Objects are created on the server only */
        super((String)name,myRoles,id, classId);        
    }
