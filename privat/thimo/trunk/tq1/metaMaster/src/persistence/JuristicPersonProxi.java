...
public class JuristicPersonProxi extends ActorProxi implements PersistentJuristicPerson{
    ...
    public RoleSearchList inverseGetRoleFor() 
        ...
        return ((PersistentJuristicPerson)this.getTheObject()).inverseGetRoleFor();
    }
    ...
    public RoleSearchList getMyRoles(final TDObserver observer) 
				throws PersistenceException{
        return ((PersistentJuristicPerson)this.getTheObject()).getMyRoles(observer);
    }
    ...
    public RoleSearchList getMyRoles() 
				throws PersistenceException{
        return ((PersistentJuristicPerson)this.getTheObject()).getMyRoles();
    }
