...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(131, "Actor");
		this.number2NameMap.put(124, "ActorManager");
		...
		this.number2NameMap.put(128, "CreateActorCommand");
		this.number2NameMap.put(123, "Customer");
		this.number2NameMap.put(-101, "ErrorDisplay");
		this.number2NameMap.put(125, "JuristicPerson");
		this.number2NameMap.put(129, "NaturalPerson");
		this.number2NameMap.put(127, "Order");
		this.number2NameMap.put(133, "Position");
		this.number2NameMap.put(126, "Product");
		this.number2NameMap.put(-102, "Server");
		this.number2NameMap.put(130, "Supplier");	
	}
