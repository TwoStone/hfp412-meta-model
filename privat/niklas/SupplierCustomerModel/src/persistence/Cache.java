...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(112, "Actor");
		this.number2NameMap.put(102, "ActorManager");
		this.number2NameMap.put(128, "AddPositionCommand");
		this.number2NameMap.put(104, "AddRoleCommand");
		this.number2NameMap.put(129, "ChangeNameCommand");
		this.number2NameMap.put(-111, "CommandCoordinator");
		this.number2NameMap.put(-103, "CommandExecuter");
		this.number2NameMap.put(113, "CommonDate");
		this.number2NameMap.put(107, "CreateActorCommand");
		this.number2NameMap.put(127, "CreateOrderCommand");
		this.number2NameMap.put(126, "CreateProductCommand");
		this.number2NameMap.put(101, "Customer");
		this.number2NameMap.put(-108, "ErrorDisplay");
		this.number2NameMap.put(106, "Order");
		this.number2NameMap.put(115, "Position");
		this.number2NameMap.put(105, "Product");
		this.number2NameMap.put(-109, "Server");
		this.number2NameMap.put(110, "Supplier");	
	}
