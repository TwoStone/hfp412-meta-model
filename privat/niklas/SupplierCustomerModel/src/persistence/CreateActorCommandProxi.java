...
public class CreateActorCommandProxi extends PersistentProxi implements PersistentCreateActorCommand{
    
    public CreateActorCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateActorCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
