...
public class AddPositionCommandICProxi extends PersistentInCacheProxi implements PersistentAddPositionCommand{
    
    public AddPositionCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddPositionCommandICProxi(PersistentObject object) {
        super(object);
    }
