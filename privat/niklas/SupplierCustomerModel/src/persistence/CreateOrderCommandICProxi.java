...
public class CreateOrderCommandICProxi extends PersistentInCacheProxi implements PersistentCreateOrderCommand{
    
    public CreateOrderCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateOrderCommandICProxi(PersistentObject object) {
        super(object);
    }
