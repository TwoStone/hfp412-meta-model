...
public class ProductProxi extends ViewProxi implements ProductView{
    ...
    public ProductView getRemoteObject(java.util.Hashtable<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        String producer = (String)resultTable.get("producer");
        ProductView result$$ = new Product((String)name,(String)producer, this.getId(), this.getClassId());
    ...
    public String getProducer() throws ModelException {
        return ((Product)this.getTheObject()).getProducer();
    }
    public void setProducer(String newValue) throws ModelException {
        ((Product)this.getTheObject()).setProducer(newValue);
    }
