...
public class Server extends ViewObject implements ServerView{
    ...
    protected ActorManagerView actors;
    protected java.util.Vector<ErrorDisplayView> errors;
    protected String user;
    
    public Server(ActorManagerView actors,java.util.Vector<ErrorDisplayView> errors,String user,long id, long classId) {
    ...
    public void resolveProxies(java.util.Hashtable<String, Object> resultTable) throws ModelException {
        ActorManagerView actors = this.getActors();
        if (actors != null) {
            ((ViewProxi)actors).setObject((ViewObject)resultTable.get(common.RPCConstantsAndServices.createHashtableKey(actors.getClassId(), actors.getId())));
        }
    ...
    public int getUserIndex() throws ModelException {
        return 0 + (this.getActors() == null ? 0 : 1);
    }
