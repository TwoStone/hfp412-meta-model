...
public class Server extends PersistentObject implements PersistentServer{
    ...
    java.util.Hashtable<String,Object> result = null;
        if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth){
            ...
            AbstractPersistentRoot actors = (AbstractPersistentRoot)this.getActors();
            if (actors != null) {
                ...
                if(depth > 1) {
                    ...
                    if(forGUI && actors.hasEssentialFields())actors.toHashtable(allResults, depth, essentialLevel + 1, false, true, tdObserver);
                }
            }
    ...
    public PersistentActorManager getActors(final TDObserver observer) 
				throws PersistenceException{
        PersistentActorManager result = getThis().getActors();
		observer.updateTransientDerived(getThis(), "actors", result);
		return result;
    }
