...
public class Product extends PersistentObject implements PersistentProduct{
    ...
    public static PersistentProduct createProduct(String name,PersistentSupplier producer) throws PersistenceException {
    ...
    public static PersistentProduct createProduct(String name,PersistentSupplier producer,PersistentProduct This) throws PersistenceException {
        if (name == null) throw new PersistenceException("Null not allowed for persistent strings, since null = \"\" in Oracle!", 0);
        PersistentProduct result = ConnectionHandler.getTheConnectionHandler().theProductFacade
            .newProduct(name);
        java.util.Hashtable<String,Object> final$$Fields = new java.util.Hashtable<String,Object>();
    ...
    java.util.Hashtable<String,Object> result = null;
        if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth){
            ...
            result.put("producer", this.producerAsString());
    ...
    protected PersistentSupplier producer;
    protected PersistentProduct This;
    
    public Product(String name,PersistentSupplier producer,PersistentProduct This,long id) throws persistence.PersistenceException {
    ...
    public void setProducer(PersistentSupplier newValue) throws PersistenceException {
        ...
        if(newValue.equals(this.producer)) return;
        long objectId = newValue.getId();
        long classId = newValue.getClassId();
        this.producer = (PersistentSupplier)PersistentProxi.createProxi(objectId, classId);
        ConnectionHandler.getTheConnectionHandler().theProductFacade.producerSet(this.getId(), newValue);
    }
    ...
    public void initialize(final Anything This, final java.util.Hashtable<String,Object> final$$Fields) 
		...
		if(this.equals(This)){
			...
			this.setProducer((PersistentSupplier)final$$Fields.get("producer"));
		}
    }
    public String producerAsString() 
				throws PersistenceException{
        return getThis().getProducer().toString();
    }
