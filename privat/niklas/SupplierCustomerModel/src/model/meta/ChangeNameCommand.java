...
public class ChangeNameCommand extends PersistentObject implements PersistentChangeNameCommand{
    ...
    public static PersistentChangeNameCommand createChangeNameCommand(String name,java.sql.Date createDate,java.sql.Date commitDate) throws PersistenceException {
        ...
        PersistentChangeNameCommand result = ConnectionHandler.getTheConnectionHandler().theChangeNameCommandFacade
            .newChangeNameCommand(name);
    ...
    public ChangeNameCommand(PersistentActor actor,String name,Invoker invoker,PersistentActorManager commandReceiver,PersistentCommonDate myCommonDate,long id) throws persistence.PersistenceException {
    ...
    public void setActor(PersistentActor newValue) throws PersistenceException {
        ...
        ConnectionHandler.getTheConnectionHandler().theChangeNameCommandFacade.actorSet(this.getId(), newValue);
    }
    ...
    public void setName(String newValue) throws PersistenceException {
        ...
        ConnectionHandler.getTheConnectionHandler().theChangeNameCommandFacade.nameSet(this.getId(), newValue);
        this.name = newValue;
    }
    ...
    public void execute() 
        ...
        try{
			this.getCommandReceiver().changeName(this.getActor(), this.getName());
		}
