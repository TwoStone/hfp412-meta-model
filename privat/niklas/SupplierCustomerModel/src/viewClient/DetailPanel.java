...
class CustomerDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String Customer$$myOrders = "Customer$$myOrders";
...
class ProductDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String Product$$producer = "Product$$producer";
    ...
    protected void addFields(){
        ...
        try{
            BaseTypePanel panel = new StringPanel(this, "producer", this.getAnything().getProducer());
            this.getScrollablePane().add(panel);
            this.panels.put(Product$$producer, panel);
        }catch(view.ModelException e){
            this.getExceptionAndEventhandler().handleException(e);
        }
...
class ServerDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String Server$$actors = "Server$$actors";
...
class SupplierDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String Supplier$$products = "Supplier$$products";
...
class ActorDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String Actor$$roles = "Actor$$roles";
...
class PositionDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String Position$$product = "Position$$product";
    protected static final String Position$$quantity = "Position$$quantity";
    ...
    protected void addFields(){
        try{
            ...
            this.getScrollablePane().add(panel);
            this.panels.put(Position$$quantity, panel);
        }catch(view.ModelException e){
            this.getExceptionAndEventhandler().handleException(e);
        }
