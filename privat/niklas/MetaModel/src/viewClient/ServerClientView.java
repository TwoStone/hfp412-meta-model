...
public class ServerClientView extends JPanel implements ExceptionAndEventHandler{
	...
	**/
    ...
    private java.util.Vector<javax.swing.JButton> getToolButtonsForStaticOperations() {
        ...
        currentButton = new javax.swing.JButton("createAspect ... ");
        currentButton.addActionListener(new java.awt.event.ActionListener(){
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ServerCreateAspectStringMssgWizard wizard = new ServerCreateAspectStringMssgWizard("createAspect");
                wizard.pack();
        ...
        currentButton.addActionListener(new java.awt.event.ActionListener(){
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ServerCreateSumTypeAbstractMetaTypeLSTMssgWizard wizard = new ServerCreateSumTypeAbstractMetaTypeLSTMssgWizard("createSumType");
                wizard.pack();
                wizard.setPreferredSize(new java.awt.Dimension(getNavigationPanel().getWidth(), wizard.getHeight()));
                wizard.pack();
                wizard.setLocationRelativeTo(getNavigationPanel());
        ...
        currentButton = new javax.swing.JButton("createType ... ");
        currentButton.addActionListener(new java.awt.event.ActionListener(){
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ServerCreateTypeStringMetaAspectMssgWizard wizard = new ServerCreateTypeStringMetaAspectMssgWizard("createType");
                wizard.pack();
                wizard.setPreferredSize(new java.awt.Dimension(getNavigationPanel().getWidth(), wizard.getHeight()));
                wizard.pack();
                wizard.setLocationRelativeTo(getNavigationPanel());
    ...
    private JPopupMenu getContextMenu(final ViewRoot selected, final boolean withStaticOperations) {
        ...
        if (withStaticOperations) result.add(item);
        if (selected != null){
            if (selected instanceof MetaTypeView){
                item = new javax.swing.JMenuItem();
                item.setText("addSupertype ... ");
                item.addActionListener(new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent e) {
                        ServerAddSupertypeMetaTypeMetaTypeMssgWizard wizard = new ServerAddSupertypeMetaTypeMetaTypeMssgWizard("addSupertype");
                        wizard.setFirstArgument((MetaTypeView)selected);
                        wizard.pack();
                        wizard.setPreferredSize(new java.awt.Dimension(getNavigationPanel().getWidth(), wizard.getHeight()));
                        wizard.pack();
                        wizard.setLocationRelativeTo(getNavigationPanel());
	...
	class ServerCreateAspectStringMssgWizard extends Wizard {

		protected ServerCreateAspectStringMssgWizard(String operationName){
			super();
			getOkButton().setText(operationName);
		}
		protected void initialize(){
			this.helpFileName = "ServerCreateAspectStringMssgWizard.help";
			super.initialize();			
		}
		...
		protected void perform() {
			try {
				getConnection().createAspect(((StringSelectionPanel)getParametersPanel().getComponent(0)).getResult());
	...
	class ServerCreateSumTypeAbstractMetaTypeLSTMssgWizard extends Wizard {

		protected ServerCreateSumTypeAbstractMetaTypeLSTMssgWizard(String operationName){
			super();
			getOkButton().setText(operationName);
		}
		protected void initialize(){
			this.helpFileName = "ServerCreateSumTypeAbstractMetaTypeLSTMssgWizard.help";
			super.initialize();			
		}
		...
		protected void perform() {
			try {
				getConnection().createSumType((java.util.Vector<AbstractMetaTypeView>)((ObjectCollectionSelectionPanel)getParametersPanel().getComponent(0)).getResult());
				getConnection().setEagerRefresh();
				setVisible(false);
				dispose();	
			}
		...
		protected void addParameters(){
			try{
				getParametersPanel().add(new ObjectCollectionSelectionPanel("types", "view.AbstractMetaTypeView", new ListRoot(((TypeManagerView)((ServerView)getConnection().getServerView()).getTypeManager()).getAllTypes()), this));
			}catch(ModelException me){;
				 handleException(me);
				 setVisible(false);
				 dispose();
	...
	class ServerCreateTypeStringMetaAspectMssgWizard extends Wizard {

		protected ServerCreateTypeStringMetaAspectMssgWizard(String operationName){
			super();
			getOkButton().setText(operationName);
		}
		protected void initialize(){
			this.helpFileName = "ServerCreateTypeStringMetaAspectMssgWizard.help";
			super.initialize();			
		}
		...
		protected void perform() {
			try {
				getConnection().createType(((StringSelectionPanel)getParametersPanel().getComponent(0)).getResult(),
									(MetaAspectView)((ObjectSelectionPanel)getParametersPanel().getComponent(1)).getResult());
				getConnection().setEagerRefresh();
				setVisible(false);
				dispose();	
			}
		...
		protected void addParameters(){
			getParametersPanel().add(new StringSelectionPanel("name", this));
			getParametersPanel().add(new ObjectSelectionPanel("aspect", "view.MetaAspectView", (ViewRoot)getConnection().getServerView(), this));		
		}	
		protected void handleDependencies(int i) {
		}
	...
	class ServerAddSupertypeMetaTypeMetaTypeMssgWizard extends Wizard {

		protected ServerAddSupertypeMetaTypeMetaTypeMssgWizard(String operationName){
			super();
			getOkButton().setText(operationName);
		}
		protected void initialize(){
			this.helpFileName = "ServerAddSupertypeMetaTypeMetaTypeMssgWizard.help";
			super.initialize();			
		}
		...
		protected void perform() {
			try {
				getConnection().addSupertype(firstArgument, (MetaTypeView)((ObjectSelectionPanel)getParametersPanel().getComponent(0)).getResult());
				getConnection().setEagerRefresh();
				setVisible(false);
				dispose();	
			}
		...
		protected void addParameters(){
			getParametersPanel().add(new ObjectSelectionPanel("superType", "view.MetaTypeView", null, this)
											{protected ViewRoot getBrowserRoot(){
												{try{
													return new ListRoot(((MetaAspectView)((MetaTypeView)((MetaTypeView)this.navigationRoot)).getMyAspect()).getTypes());
												}catch(ModelException me){
		...
		private MetaTypeView firstArgument; 
	
		public void setFirstArgument(MetaTypeView firstArgument){
