...
class MetaAssociationDefaultDetailPanel extends DefaultDetailPanel{
    ...
    protected static final String NamedEntity$$name = "NamedEntity$$name";
    protected static final String MetaAssociation$$fromType = "MetaAssociation$$fromType";
    protected static final String MetaAssociation$$toType = "MetaAssociation$$toType";
