...
public class MetaAspectICProxi extends NamedEntityICProxi implements PersistentMetaAspect{
    
    public MetaAspectICProxi(long objectId) {
        super(objectId);
    }
    public MetaAspectICProxi(PersistentObject object) {
        super(object);
    }
