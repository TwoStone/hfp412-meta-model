...
public class CreateAspectCommandFacade{
    ...
    public CreateAspectCommandProxi newCreateAspectCommand(String name) throws PersistenceException {
        ...
        try{
            ...
            return (CreateAspectCommandProxi)PersistentProxi.createProxi(id, 132);
