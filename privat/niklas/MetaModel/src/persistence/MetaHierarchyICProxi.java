...
public class MetaHierarchyICProxi extends NamedEntityICProxi implements PersistentMetaHierarchy{
    
    public MetaHierarchyICProxi(long objectId) {
        super(objectId);
    }
    public MetaHierarchyICProxi(PersistentObject object) {
        super(object);
    }
