...
public abstract class ComposedMetaTypeProxi extends AbstractMetaTypeProxi implements PersistentComposedMetaType{
    ...
    public PersistentOrMetaType getDisjunctiveNormalform(final TDObserver observer) 
        ...
        return ((PersistentComposedMetaType)this.getTheObject()).getDisjunctiveNormalform(observer);
    }
    ...
    public PersistentOrMetaType getDisjunctiveNormalform() 
				throws PersistenceException{
        return ((PersistentComposedMetaType)this.getTheObject()).getDisjunctiveNormalform();
    }
