...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(118, "AndMetaType");
		this.number2NameMap.put(131, "AspectManager");
		this.number2NameMap.put(128, "CONCNamedEntity");
		this.number2NameMap.put(-133, "CommandCoordinator");
		this.number2NameMap.put(-130, "CommandExecuter");
		this.number2NameMap.put(134, "CommonDate");
		this.number2NameMap.put(132, "CreateAspectCommand");
		this.number2NameMap.put(135, "CreateTypeCommand");
		this.number2NameMap.put(-109, "ErrorDisplay");
		this.number2NameMap.put(119, "MetaAspect");
		this.number2NameMap.put(126, "MetaAssociation");
		this.number2NameMap.put(121, "MetaHierarchy");
		this.number2NameMap.put(122, "MetaType");
		this.number2NameMap.put(117, "OrMetaType");
		this.number2NameMap.put(-125, "Server");
		this.number2NameMap.put(129, "TypeManager");	
	}
