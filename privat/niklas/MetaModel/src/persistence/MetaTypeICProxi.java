...
public class MetaTypeICProxi extends AbstractMetaTypeICProxi implements PersistentMetaType{
    
    public MetaTypeICProxi(long objectId) {
        super(objectId);
    }
    public MetaTypeICProxi(PersistentObject object) {
        super(object);
    }
