...
public class CONCNamedEntityProxi extends NamedEntityProxi implements PersistentCONCNamedEntity{
    
    public CONCNamedEntityProxi(long objectId) {
        super(objectId);
    }
    public CONCNamedEntityProxi(PersistentInCacheProxi object) {
        super(object);
    }
