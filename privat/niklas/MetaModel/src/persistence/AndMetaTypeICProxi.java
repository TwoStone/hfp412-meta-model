...
public class AndMetaTypeICProxi extends ComposedMetaTypeICProxi implements PersistentAndMetaType{
    
    public AndMetaTypeICProxi(long objectId) {
        super(objectId);
    }
    public AndMetaTypeICProxi(PersistentObject object) {
        super(object);
    }
