...
public class CreateTypeCommandProxi extends PersistentProxi implements PersistentCreateTypeCommand{
    
    public CreateTypeCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateTypeCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
