...
public class OrMetaTypeProxi extends ComposedMetaTypeProxi implements PersistentOrMetaType{
    
    public OrMetaTypeProxi(long objectId) {
        super(objectId);
    }
    public OrMetaTypeProxi(PersistentInCacheProxi object) {
        super(object);
    }
