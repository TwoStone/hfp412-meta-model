...
public class ConnectionHandler {
    ...
    public CONCNamedEntityFacade theCONCNamedEntityFacade;
    public TypeManagerFacade theTypeManagerFacade;
    public CommandExecuterFacade theCommandExecuterFacade;
    public OrMetaTypeFacade theOrMetaTypeFacade;
    public AspectManagerFacade theAspectManagerFacade;
    public MetaAspectFacade theMetaAspectFacade;
    public ErrorDisplayFacade theErrorDisplayFacade;
    public ServerFacade theServerFacade;
    public NamedEntityFacade theNamedEntityFacade;
    public MetaAssociationFacade theMetaAssociationFacade;
    public CreateAspectCommandFacade theCreateAspectCommandFacade;
    public CommandCoordinatorFacade theCommandCoordinatorFacade;
    public CommonDateFacade theCommonDateFacade;
    public AndMetaTypeFacade theAndMetaTypeFacade;
    public AbstractMetaTypeFacade theAbstractMetaTypeFacade;
    public MetaHierarchyFacade theMetaHierarchyFacade;
    public ComposedMetaTypeFacade theComposedMetaTypeFacade;
    public MetaTypeFacade theMetaTypeFacade;
    public CreateTypeCommandFacade theCreateTypeCommandFacade;
	...
	public void connect(String databaseName, String currentSchemaName, String user, char[] pw, boolean autoCommit) throws PersistenceException {
		try {
			...
			callable.execute();
			callable.close();
            this.theCONCNamedEntityFacade= new CONCNamedEntityFacade(this.schemaName, this.con);
            ...
            this.theOrMetaTypeFacade= new OrMetaTypeFacade(this.schemaName, this.con);
            this.theAspectManagerFacade= new AspectManagerFacade(this.schemaName, this.con);
            this.theMetaAspectFacade= new MetaAspectFacade(this.schemaName, this.con);
            this.theErrorDisplayFacade= new ErrorDisplayFacade();
            this.theServerFacade= new ServerFacade(this.schemaName, this.con);
            this.theNamedEntityFacade= new NamedEntityFacade(this.schemaName, this.con);
            this.theMetaAssociationFacade= new MetaAssociationFacade(this.schemaName, this.con);
            ...
            this.theAndMetaTypeFacade= new AndMetaTypeFacade(this.schemaName, this.con);
            this.theAbstractMetaTypeFacade= new AbstractMetaTypeFacade(this.schemaName, this.con);
            this.theMetaHierarchyFacade= new MetaHierarchyFacade(this.schemaName, this.con);
            this.theComposedMetaTypeFacade= new ComposedMetaTypeFacade(this.schemaName, this.con);
            this.theMetaTypeFacade= new MetaTypeFacade(this.schemaName, this.con);
            this.theCreateTypeCommandFacade= new CreateTypeCommandFacade(this.schemaName, this.con);
		} catch (SQLException sqlExc) {
			throw new PersistenceException(sqlExc.getMessage(), sqlExc.getErrorCode());
		}
	}
