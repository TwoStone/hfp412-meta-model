...
public class OrMetaType extends model.ComposedMetaType implements PersistentOrMetaType{
    ...
    public static PersistentOrMetaType createOrMetaType(PersistentOrMetaType This) throws PersistenceException {
        PersistentOrMetaType result = ConnectionHandler.getTheConnectionHandler().theOrMetaTypeFacade
            .newOrMetaType();
        java.util.Hashtable<String,Object> final$$Fields = new java.util.Hashtable<String,Object>();
    ...
    public OrMetaType(PersistentAbstractMetaType This,long id) throws persistence.PersistenceException {
