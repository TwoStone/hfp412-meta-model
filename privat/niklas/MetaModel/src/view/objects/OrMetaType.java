...
public class OrMetaType extends view.objects.ComposedMetaType implements OrMetaTypeView{
    
    
    public OrMetaType(java.util.Vector<AbstractMetaTypeView> components,OrMetaTypeView disjunctiveNormalform,long id, long classId) {
