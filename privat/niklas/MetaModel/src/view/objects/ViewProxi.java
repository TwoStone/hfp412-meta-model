	...
	if (proxiFactories == null){
        ...
        proxiFactories[27] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new CONCNamedEntityProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[16] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new OrMetaTypeProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[18] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new MetaAspectProxi(objectId, classId, connectionKey);
            }
        };
        ...
        proxiFactories[25] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new MetaAssociationProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[17] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new AndMetaTypeProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[20] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new MetaHierarchyProxi(objectId, classId, connectionKey);
            }
        };
        proxiFactories[21] = new ProxiFactory(){
            ViewProxi create(long objectId, long classId, ExceptionAndEventHandler connectionKey){
                return new MetaTypeProxi(objectId, classId, connectionKey);
            }
        };
	}
