...
create table NmdEntt(
    ...
    MtAssctnSrc number,
    MtAssctnSrcCls number,
    constraint FMtAssctnSrc foreign key (MtAssctnSrcCls) references Cls (id),
    MtAssctnTrgt number,
    MtAssctnTrgtCls number,
    constraint FMtAssctnTrgt foreign key (MtAssctnTrgtCls) references Cls (id)    
);
