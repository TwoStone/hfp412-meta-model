...
public interface AnythingExceptionVisitor<E extends model.UserException> extends RolleExceptionVisitor<E>,CommonDateExceptionVisitor<E>{
    ...
    public void handleTransactionManager(PersistentTransactionManager transactionManager) throws PersistenceException, E;
