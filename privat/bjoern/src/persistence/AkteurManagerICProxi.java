...
public class AkteurManagerICProxi extends PersistentInCacheProxiOptimistic implements PersistentAkteurManager{
    
    public AkteurManagerICProxi(long objectId) {
        super(objectId);
    }
    public AkteurManagerICProxi(PersistentObject object) {
        super(object);
    }
