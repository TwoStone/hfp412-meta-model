...
public class TransactionManagerProxi extends PersistentProxi implements PersistentTransactionManager{
    
    public TransactionManagerProxi(long objectId) {
        super(objectId);
    }
    public TransactionManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
