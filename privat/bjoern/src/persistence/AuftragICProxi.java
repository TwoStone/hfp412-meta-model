...
public class AuftragICProxi extends PersistentInCacheProxiOptimistic implements PersistentAuftrag{
    
    public AuftragICProxi(long objectId) {
        super(objectId);
    }
    public AuftragICProxi(PersistentObject object) {
        super(object);
    }
