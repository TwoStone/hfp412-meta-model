...
public class CreateAkteurCommandProxi extends PersistentProxi implements PersistentCreateAkteurCommand{
    
    public CreateAkteurCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateAkteurCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
