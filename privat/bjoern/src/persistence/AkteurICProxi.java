...
public class AkteurICProxi extends PersistentInCacheProxiOptimistic implements PersistentAkteur{
    
    public AkteurICProxi(long objectId) {
        super(objectId);
    }
    public AkteurICProxi(PersistentObject object) {
        super(object);
    }
