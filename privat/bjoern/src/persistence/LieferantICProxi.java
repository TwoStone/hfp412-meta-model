...
public class LieferantICProxi extends RolleICProxi implements PersistentLieferant{
    
    public LieferantICProxi(long objectId) {
        super(objectId);
    }
    public LieferantICProxi(PersistentObject object) {
        super(object);
    }
