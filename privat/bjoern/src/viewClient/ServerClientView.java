...
public class ServerClientView extends JPanel implements ExceptionAndEventHandler{
	...
	**/
    ...
    private java.util.Vector<javax.swing.JButton> getToolButtonsForStaticOperations() {
        ...
        currentButton = new javax.swing.JButton("createAkteur ... ");
        currentButton.addActionListener(new java.awt.event.ActionListener(){
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ServerCreateAkteurStringMssgWizard wizard = new ServerCreateAkteurStringMssgWizard("createAkteur");
                wizard.pack();
    ...
    private JPopupMenu getContextMenu(final ViewRoot selected, final boolean withStaticOperations) {
        ...
        if (withStaticOperations) result.add(item);
        if (selected != null){
            if (selected instanceof AkteurView){
                item = new javax.swing.JMenuItem();
                item.setText("addRole ... ");
                item.addActionListener(new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent e) {
                        ServerAddRoleAkteurRolleSUBTYPENameMssgWizard wizard = new ServerAddRoleAkteurRolleSUBTYPENameMssgWizard("addRole");
                ...
                item.addActionListener(new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent e) {
                        ServerChangeNameAkteurStringMssgWizard wizard = new ServerChangeNameAkteurStringMssgWizard("changeName");
                        wizard.setFirstArgument((AkteurView)selected);
                        wizard.pack();
                        wizard.setPreferredSize(new java.awt.Dimension(getNavigationPanel().getWidth(), wizard.getHeight()));
                        wizard.pack();
	...
	class ServerChangeNameAkteurStringMssgWizard extends Wizard {
		...
		protected void initialize(){
			this.helpFileName = "ServerChangeNameAkteurStringMssgWizard.help";
			super.initialize();			
		}
		...
		protected void addParameters(){
			getParametersPanel().add(new StringSelectionPanel("nme", this));		
		}	
		protected void handleDependencies(int i) {
		}
